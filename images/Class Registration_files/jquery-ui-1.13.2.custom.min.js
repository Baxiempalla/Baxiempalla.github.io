(function(d){"function"===typeof define&&define.amd?define(["jquery"],d):d(jQuery)})(function(d){function ea(a){for(var b;a.length&&a[0]!==document;){b=a.css("position");if("absolute"===b||"relative"===b||"fixed"===b)if(b=parseInt(a.css("zIndex"),10),!isNaN(b)&&0!==b)return b;a=a.parent()}return 0}function W(){this._curInst=null;this._keyEvent=!1;this._disabledInputs=[];this._inDialog=this._datepickerShowing=!1;this._mainDivId="ui-datepicker-div";this._inlineClass="ui-datepicker-inline";this._appendClass=
...
constrainInput:!0,showButtonPanel:!1,autoSize:!1,disabled:!1};d.extend(this._defaults,this.regional[""]);this.regional.en=d.extend(!0,{},this.regional[""]);this.regional["en-US"]=d.extend(!0,{},this.regional.en);this.dpDiv=X(d("<div id='"+this._mainDivId+"' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))}function X(a){return a.on("mouseout","button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a",function(){d(this).removeClass("ui-state-hover");
-1!==this.className.indexOf("ui-datepicker-prev")&&d(this).removeClass("ui-datepicker-prev-hover");-1!==this.className.indexOf("ui-datepicker-next")&&d(this).removeClass("ui-datepicker-next-hover")}).on("mouseover","button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a",Y)}function Y(){if(!d.datepicker._isDisabledDatepicker(H.inline?H.dpDiv.parent()[0]:H.input[0]))d(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),d(this).addClass("ui-state-hover"),
-1!==this.className.indexOf("ui-datepicker-prev")&&d(this).addClass("ui-datepicker-prev-hover"),-1!==this.className.indexOf("ui-datepicker-next")&&d(this).addClass("ui-datepicker-next-hover")}function P(a,b){d.extend(a,b);for(var c in b)null==b[c]&&(a[c]=b[c]);return a}function I(a){return function(){var b=this.element.val();a.apply(this,arguments);this._refresh();b!==this.element.val()&&this._trigger("change")}}function J(a){return null==a?a+"":"object"===typeof a?T[fa.call(a)]||"object":typeof a}
function Q(a,b,c){var d=Z[b.type]||{};if(null==a)return c||!b.def?null:b.def;a=d.floor?~~a:parseFloat(a);return isNaN(a)?b.def:d.mod?(a+d.mod)%d.mod:Math.min(d.max,Math.max(0,a))}function $(a){var b=z(),c=b._rgba=[];a=a.toLowerCase();D(ga,function(d,e){var g,h=e.re.exec(a);g=h&&e.parse(h);h=e.space||"rgba";if(g)return g=b[h](g),b[F[h].cache]=g[F[h].cache],c=b._rgba=g._rgba,!1});return c.length?("0,0,0,0"===c.join()&&x.extend(c,R.transparent),b):R[a]}function U(a,b,c){c=(c+1)%1;return 1>6*c?a+6*(b-
a)*c:1>2*c?b:2>3*c?a+6*(b-a)*(2/3-c):a}d.ui=d.ui||{};d.ui.version="1.13.2";var ha=0,ia=Array.prototype.hasOwnProperty,aa=Array.prototype.slice;d.cleanData=function(a){return function(b){var c,f,e;for(e=0;null!=(f=b[e]);e++)(c=d._data(f,"events"))&&c.remove&&d(f).triggerHandler("remove");a(b)}}(d.cleanData);d.widget=function(a,b,c){var f,e,g,h={},k=a.split(".")[0];a=a.split(".")[1];var l=k+"-"+a;c||(c=b,b=d.Widget);Array.isArray(c)&&(c=d.extend.apply(null,[{}].concat(c)));d.expr.pseudos[l.toLowerCase()]=
...
aa.call(arguments,1),c=0,f=b.length,e,g;c<f;c++)for(e in b[c])g=b[c][e],ia.call(b[c],e)&&void 0!==g&&(d.isPlainObject(g)?a[e]=d.isPlainObject(a[e])?d.widget.extend({},a[e],g):d.widget.extend({},g):a[e]=g);return a};d.widget.bridge=function(a,b){var c=b.prototype.widgetFullName||a;d.fn[a]=function(f){var e="string"===typeof f,g=aa.call(arguments,1),h=this;e?!this.length&&"instance"===f?h=void 0:this.each(function(){var b,e=d.data(this,c);if("instance"===f)return h=e,!1;if(!e)return d.error("cannot call methods on "+
a+" prior to initialization; attempted to call method '"+f+"'");if("function"!==typeof e[f]||"_"===f.charAt(0))return d.error("no such method '"+f+"' for "+a+" widget instance");b=e[f].apply(e,g);if(b!==e&&void 0!==b)return h=b&&b.jquery?h.pushStack(b.get()):b,!1}):(g.length&&(f=d.widget.extend.apply(null,[f].concat(g))),this.each(function(){var a=d.data(this,c);a?(a.option(f||{}),a._init&&a._init()):d.data(this,c,new b(f,this))}));return h}};d.Widget=function(){};d.Widget._childConstructors=[];d.Widget.prototype=
{widgetName:"widget",widgetEventPrefix:"",defaultElement:"<div>",options:{classes:{},disabled:!1,create:null},_createWidget:function(a,b){b=d(b||this.defaultElement||this)[0];this.element=d(b);this.uuid=ha++;this.eventNamespace="."+this.widgetName+this.uuid;this.bindings=d();this.hoverable=d();this.focusable=d();this.classesElementLookup={};b!==this&&(d.data(b,this.widgetFullName,this),this._on(!0,this.element,{remove:function(a){a.target===b&&this.destroy()}}),this.document=d(b.style?b.ownerDocument:
b.document||b),this.window=d(this.document[0].defaultView||this.document[0].parentWindow));this.options=d.widget.extend({},this.options,this._getCreateOptions(),a);this._create();this.options.disabled&&this._setOptionDisabled(this.options.disabled);this._trigger("create",null,this._getCreateEventData());this._init()},_getCreateOptions:function(){return{}},_getCreateEventData:d.noop,_create:d.noop,_init:d.noop,destroy:function(){var a=this;this._destroy();d.each(this.classesElementLookup,function(b,
c){a._removeClass(c,b)});this.element.off(this.eventNamespace).removeData(this.widgetFullName);this.widget().off(this.eventNamespace).removeAttr("aria-disabled");this.bindings.off(this.eventNamespace)},_destroy:d.noop,widget:function(){return this.element},option:function(a,b){var c=a,f,e,g;if(0===arguments.length)return d.widget.extend({},this.options);if("string"===typeof a)if(c={},f=a.split("."),a=f.shift(),f.length){e=c[a]=d.widget.extend({},this.options[a]);for(g=0;g<f.length-1;g++)e[f[g]]=e[f[g]]||
{},e=e[f[g]];a=f.pop();if(1===arguments.length)return void 0===e[a]?null:e[a];e[a]=b}else{if(1===arguments.length)return void 0===this.options[a]?null:this.options[a];c[a]=b}this._setOptions(c);return this},_setOptions:function(a){for(var b in a)this._setOption(b,a[b]);return this},_setOption:function(a,b){"classes"===a&&this._setOptionClasses(b);this.options[a]=b;"disabled"===a&&this._setOptionDisabled(b);return this},_setOptionClasses:function(a){var b,c,f;for(b in a)f=this.classesElementLookup[b],
...
typeof a||null===a;a={extra:e?b:c,keys:e?a:b,element:e?this.element:a,add:d};a.element.toggleClass(this._classes(a),d);return this},_on:function(a,b,c){var f,e=this;"boolean"!==typeof a&&(c=b,b=a,a=!1);c?(b=f=d(b),this.bindings=this.bindings.add(b)):(c=b,b=this.element,f=this.widget());d.each(c,function(c,h){function k(){if(a||!(!0===e.options.disabled||d(this).hasClass("ui-state-disabled")))return("string"===typeof h?e[h]:h).apply(e,arguments)}"string"!==typeof h&&(k.guid=h.guid=h.guid||k.guid||
d.guid++);var l=c.match(/^([\w:-]*)\s*(.*)$/),m=l[1]+e.eventNamespace;if(l=l[2])f.on(m,l,k);else b.on(m,k)})},_off:function(a,b){b=(b||"").split(" ").join(this.eventNamespace+" ")+this.eventNamespace;a.off(b);this.bindings=d(this.bindings.not(a).get());this.focusable=d(this.focusable.not(a).get());this.hoverable=d(this.hoverable.not(a).get())},_delay:function(a,b){var c=this;return setTimeout(function(){return("string"===typeof a?c[a]:a).apply(c,arguments)},b||0)},_hoverable:function(a){this.hoverable=
this.hoverable.add(a);this._on(a,{mouseenter:function(a){this._addClass(d(a.currentTarget),null,"ui-state-hover")},mouseleave:function(a){this._removeClass(d(a.currentTarget),null,"ui-state-hover")}})},_focusable:function(a){this.focusable=this.focusable.add(a);this._on(a,{focusin:function(a){this._addClass(d(a.currentTarget),null,"ui-state-focus")},focusout:function(a){this._removeClass(d(a.currentTarget),null,"ui-state-focus")}})},_trigger:function(a,b,c){var f,e=this.options[a];c=c||{};b=d.Event(b);
b.type=(a===this.widgetEventPrefix?a:this.widgetEventPrefix+a).toLowerCase();b.target=this.element[0];if(a=b.originalEvent)for(f in a)f in b||(b[f]=a[f]);this.element.trigger(b,c);return!("function"===typeof e&&!1===e.apply(this.element[0],[b].concat(c))||b.isDefaultPrevented())}};d.each({show:"fadeIn",hide:"fadeOut"},function(a,b){d.Widget.prototype["_"+a]=function(c,f,e){"string"===typeof f&&(f={effect:f});var g,h=!f?a:!0===f||"number"===typeof f?b:f.effect||b;f=f||{};"number"===typeof f?f={duration:f}:
!0===f&&(f={});g=!d.isEmptyObject(f);f.complete=e;f.delay&&c.delay(f.delay);if(g&&d.effects&&d.effects.effect[h])c[a](f);else if(h!==a&&c[h])c[h](f.duration,f.easing,e);else c.queue(function(b){d(this)[a]();e&&e.call(c[0]);b()})}});(function(){function a(a,b,c){return[parseFloat(a[0])*(m.test(a[0])?b/100:1),parseFloat(a[1])*(m.test(a[1])?c/100:1)]}function b(a){var b=a[0];return 9===b.nodeType?{width:a.width(),height:a.height(),offset:{top:0,left:0}}:null!=b&&b===b.window?{width:a.width(),height:a.height(),
offset:{top:a.scrollTop(),left:a.scrollLeft()}}:b.preventDefault?{width:0,height:0,offset:{top:b.pageY,left:b.pageX}}:{width:a.outerWidth(),height:a.outerHeight(),offset:a.offset()}}var c,f=Math.max,e=Math.abs,g=/left|center|right/,h=/top|center|bottom/,k=/[\+\-]\d+(\.[\d]+)?%?/,l=/^\w+/,m=/%$/,n=d.fn.position;d.position={scrollbarWidth:function(){if(void 0!==c)return c;var a,b,f=d("<div style='display:block;position:absolute;width:200px;height:200px;overflow:hidden;'><div style='height:300px;width:auto;'></div></div>");
...
getWithinInfo:function(a){var b=d(a||window),c=null!=b[0]&&b[0]===b[0].window,f=!!b[0]&&9===b[0].nodeType;return{element:b,isWindow:c,isDocument:f,offset:!c&&!f?d(a).offset():{left:0,top:0},scrollLeft:b.scrollLeft(),scrollTop:b.scrollTop(),width:b.outerWidth(),height:b.outerHeight()}}};d.fn.position=function(c){if(!c||!c.of)return n.apply(this,arguments);c=d.extend({},c);var m,u,t,r,s,v,w="string"===typeof c.of?d(document).find(c.of):d(c.of),ba=d.position.getWithinInfo(c.within),B=d.position.getScrollInfo(ba),
E=(c.collision||"flip").split(" "),y={};v=b(w);w[0].preventDefault&&(c.at="left top");u=v.width;t=v.height;r=v.offset;s=d.extend({docked:c.docked,rtl:c.rtl},r);d.each(["my","at"],function(){var a=(c[this]||"").split(" "),b,d;1===a.length&&(a=g.test(a[0])?a.concat(["center"]):h.test(a[0])?["center"].concat(a):["center","center"]);a[0]=g.test(a[0])?a[0]:"center";a[1]=h.test(a[1])?a[1]:"center";b=k.exec(a[0]);d=k.exec(a[1]);y[this]=[b?b[0]:0,d?d[0]:0];c[this]=[l.exec(a[0])[0],l.exec(a[1])[0]]});1===
E.length&&(E[1]=E[0]);"right"===c.at[0]?s.left+=u:"center"===c.at[0]&&(s.left+=u/2);"bottom"===c.at[1]?s.top+=t:"center"===c.at[1]&&(s.top+=t/2);m=a(y.at,u,t);s.left+=m[0];s.top+=m[1];return this.each(function(){var b,g,h=d(this),k=h.outerWidth(),l=h.outerHeight(),n=parseInt(d.css(this,"marginLeft"),10)||0,v=parseInt(d.css(this,"marginTop"),10)||0,z=k+n+(parseInt(d.css(this,"marginRight"),10)||0)+B.width,A=l+v+(parseInt(d.css(this,"marginBottom"),10)||0)+B.height,C=d.extend({},s),x=a(y.my,h.outerWidth(),
h.outerHeight());"right"===c.my[0]?C.left-=k:"center"===c.my[0]&&(C.left-=k/2);"bottom"===c.my[1]?C.top-=l:"center"===c.my[1]&&(C.top-=l/2);C.left+=x[0];C.top+=x[1];b={marginLeft:n,marginTop:v};d.each(["left","top"],function(a,f){if(d.ui.position[E[a]])d.ui.position[E[a]][f](C,{targetWidth:u,targetHeight:t,elemWidth:k,elemHeight:l,collisionPosition:b,collisionWidth:z,collisionHeight:A,offset:[m[0]+x[0],m[1]+x[1]],my:c.my,at:c.at,within:ba,elem:h})});c.using&&(g=function(a){var b=r.left-C.left,d=b+
u-k,g=r.top-C.top,m=g+t-l,n={target:{element:w,left:r.left,top:r.top,width:u,height:t},element:{element:h,left:C.left,top:C.top,width:k,height:l},horizontal:0>d?"left":0<b?"right":"center",vertical:0>m?"top":0<g?"bottom":"middle"};u<k&&e(b+d)<u&&(n.horizontal="center");t<l&&e(g+m)<t&&(n.vertical="middle");f(e(b),e(d))>f(e(g),e(m))?n.important="horizontal":n.important="vertical";c.using.call(this,a,n)});g=d.extend(C,{using:g});g.rtl&&!g.docked&&h.hasClass("ui-dialog")?h.css({"inset-block-start":g.top+
"px","inset-inline-start":g.left+"px"}):h.offset(g)})};d.ui.position={fit:{left:function(a,b){var c=b.within,d=c.isWindow?c.scrollLeft:c.offset.left,e=c.width,g=a.left-b.collisionPosition.marginLeft,c=d-g,h=g+b.collisionWidth-e-d;b.collisionWidth>e?0<c&&0>=h?(d=a.left+c+b.collisionWidth-e-d,a.left+=c-d):a.left=0<h&&0>=c?d:c>h?d+e-b.collisionWidth:d:a.left=0<c?a.left+c:0<h?a.left-h:f(a.left-g,a.left)},top:function(a,b){var c=b.within,d=c.isWindow?c.scrollTop:c.offset.top,e=b.within.height,g=a.top-
b.collisionPosition.marginTop,c=d-g,h=g+b.collisionHeight-e-d;b.collisionHeight>e?0<c&&0>=h?(d=a.top+c+b.collisionHeight-e-d,a.top+=c-d):a.top=0<h&&0>=c?d:c>h?d+e-b.collisionHeight:d:a.top=0<c?a.top+c:0<h?a.top-h:f(a.top-g,a.top)}},flip:{left:function(a,b){var c=b.within,d=c.offset.left+c.scrollLeft,f=c.width,g=c.isWindow?c.scrollLeft:c.offset.left,h=a.left-b.collisionPosition.marginLeft,c=h-g,k=h+b.collisionWidth-f-g,h="left"===b.my[0]?-b.elemWidth:"right"===b.my[0]?b.elemWidth:0,l="left"===b.at[0]?
b.targetWidth:"right"===b.at[0]?-b.targetWidth:0,m=-2*b.offset[0];if(0>c){if(d=a.left+h+l+m+b.collisionWidth-f-d,0>d||d<e(c))a.left+=h+l+m}else if(0<k&&(d=a.left-b.collisionPosition.marginLeft+h+l+m-g,0<d||e(d)<k))a.left+=h+l+m},top:function(a,b){var c=b.within,d=c.offset.top+c.scrollTop,f=c.height,g=c.isWindow?c.scrollTop:c.offset.top,h=a.top-b.collisionPosition.marginTop,c=h-g,k=h+b.collisionHeight-f-g,h="top"===b.my[1]?-b.elemHeight:"bottom"===b.my[1]?b.elemHeight:0,l="top"===b.at[1]?b.targetHeight:
"bottom"===b.at[1]?-b.targetHeight:0,m=-2*b.offset[1];if(0>c){if(d=a.top+h+l+m+b.collisionHeight-f-d,0>d||d<e(c))a.top+=h+l+m}else if(0<k&&(d=a.top-b.collisionPosition.marginTop+h+l+m-g,0<d||e(d)<k))a.top+=h+l+m}},flipfit:{left:function(){d.ui.position.flip.left.apply(this,arguments);d.ui.position.fit.left.apply(this,arguments)},top:function(){d.ui.position.flip.top.apply(this,arguments);d.ui.position.fit.top.apply(this,arguments)}}}})();d.extend(d.expr.pseudos,{data:d.expr.createPseudo?d.expr.createPseudo(function(a){return function(b){return!!d.data(b,
...
f+"']");return 0<c.length&&c.is(":visible")}if(/^(input|select|textarea|button|object)$/.test(c)){if(c=!a.disabled)(f=d(a).closest("fieldset")[0])&&(c=!f.disabled)}else c="a"===c?a.href||b:b;if(c&&(c=d(a).is(":visible"))){c=d(a);for(f=c.css("visibility");"inherit"===f;)c=c.parent(),f=c.css("visibility");c="visible"===f}return c};d.extend(d.expr.pseudos,{focusable:function(a){return d.ui.focusable(a,null!=d.attr(a,"tabindex"))}});d.fn._form=function(){return"string"===typeof this[0].form?this.closest("form"):
d(this[0].form)};d.ui.formResetMixin={_formResetHandler:function(){var a=d(this);setTimeout(function(){var b=a.data("ui-form-reset-instances");d.each(b,function(){this.refresh()})})},_bindFormResetHandler:function(){this.form=this.element._form();if(this.form.length){var a=this.form.data("ui-form-reset-instances")||[];if(!a.length)this.form.on("reset.ui-form-reset",this._formResetHandler);a.push(this);this.form.data("ui-form-reset-instances",a)}},_unbindFormResetHandler:function(){if(this.form.length){var a=
this.form.data("ui-form-reset-instances");a.splice(d.inArray(this,a),1);a.length?this.form.data("ui-form-reset-instances",a):this.form.removeData("ui-form-reset-instances").off("reset.ui-form-reset")}}};d.expr.pseudos||(d.expr.pseudos=d.expr[":"]);d.uniqueSort||(d.uniqueSort=d.unique);if(!d.escapeSelector){var ja=/([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g,ka=function(a,b){return b?"\x00"===a?"\ufffd":a.slice(0,-1)+"\\"+a.charCodeAt(a.length-1).toString(16)+" ":"\\"+a};d.escapeSelector=function(a){return(a+
"").replace(ja,ka)}}(!d.fn.even||!d.fn.odd)&&d.fn.extend({even:function(){return this.filter(function(a){return 0===a%2})},odd:function(){return this.filter(function(a){return 1===a%2})}});d.ui.keyCode={BACKSPACE:8,COMMA:188,DELETE:46,DOWN:40,END:35,ENTER:13,ESCAPE:27,HOME:36,LEFT:37,PAGE_DOWN:34,PAGE_UP:33,PERIOD:190,RIGHT:39,SPACE:32,TAB:9,UP:38};d.fn.labels=function(){var a,b,c;if(!this.length)return this.pushStack([]);if(this[0].labels&&this[0].labels.length)return this.pushStack(this[0].labels);
c=this.eq(0).parents("label");if(b=this.attr("id"))a=this.eq(0).parents().last(),a=a.add(a.length?a.siblings():this.siblings()),b="label[for='"+d.escapeSelector(b)+"']",c=c.add(a.find(b).addBack(b));return this.pushStack(c)};d.fn.scrollParent=function(a){var b=this.css("position"),c="absolute"===b,f=a?/(auto|scroll|hidden)/:/(auto|scroll)/;a=this.parents().filter(function(){var a=d(this);return c&&"static"===a.css("position")?!1:f.test(a.css("overflow")+a.css("overflow-y")+a.css("overflow-x"))}).eq(0);
return"fixed"===b||!a.length?d(this[0].ownerDocument||document):a};d.extend(d.expr.pseudos,{tabbable:function(a){var b=d.attr(a,"tabindex"),c=null!=b;return(!c||0<=b)&&d.ui.focusable(a,c)}});d.fn.extend({uniqueId:function(){var a=0;return function(){return this.each(function(){this.id||(this.id="ui-id-"+ ++a)})}}(),removeUniqueId:function(){return this.each(function(){/^ui-id-\d+$/.test(this.id)&&d(this).removeAttr("id")})}});d.ui.ie=!!/msie [\w.]+/.exec(navigator.userAgent.toLowerCase());var S=!1;
d(document).on("mouseup",function(){S=!1});d.widget("ui.mouse",{version:"1.13.2",options:{cancel:"input, textarea, button, select, option",distance:1,delay:0},_mouseInit:function(){var a=this;this.element.on("mousedown."+this.widgetName,function(b){return a._mouseDown(b)}).on("click."+this.widgetName,function(b){if(!0===d.data(b.target,a.widgetName+".preventClickEvent"))return d.removeData(b.target,a.widgetName+".preventClickEvent"),b.stopImmediatePropagation(),!1});this.started=!1},_mouseDestroy:function(){this.element.off("."+
...
this.options,c="function"===typeof b.helper;a=c?d(b.helper.apply(this.element[0],[a])):"clone"===b.helper?this.element.clone().removeAttr("id"):this.element;a.parents("body").length||a.appendTo("parent"===b.appendTo?this.element[0].parentNode:b.appendTo);c&&a[0]===this.element[0]&&this._setPositionRelative();a[0]!==this.element[0]&&!/(fixed|absolute)/.test(a.css("position"))&&a.css("position","absolute");return a},_setPositionRelative:function(){/^(?:r|a|f)/.test(this.element.css("position"))||(this.element[0].style.position=
...
a===this.document[0]},_getParentOffset:function(){var a=this.offsetParent.offset(),b=this.document[0];"absolute"===this.cssPosition&&(this.scrollParent[0]!==b&&d.contains(this.scrollParent[0],this.offsetParent[0]))&&(a.left+=this.scrollParent.scrollLeft(),a.top+=this.scrollParent.scrollTop());this._isRootNode(this.offsetParent[0])&&(a={top:0,left:0});return{top:a.top+(parseInt(this.offsetParent.css("borderTopWidth"),10)||0),left:a.left+(parseInt(this.offsetParent.css("borderLeftWidth"),10)||0)}},
...
stop:function(a,b,c){a=c.options;a._opacity&&d(b.helper).css("opacity",a._opacity)}});d.ui.plugin.add("draggable","scroll",{start:function(a,b,c){c.scrollParentNotHidden||(c.scrollParentNotHidden=c.helper.scrollParent(!1));c.scrollParentNotHidden[0]!==c.document[0]&&"HTML"!==c.scrollParentNotHidden[0].tagName&&(c.overflowOffset=c.scrollParentNotHidden.offset())},drag:function(a,b,c){b=c.options;var f=!1,e=c.scrollParentNotHidden[0],g=c.document[0];if(e!==g&&"HTML"!==e.tagName){if(!b.axis||"x"!==b.axis)c.overflowOffset.top+
e.offsetHeight-a.pageY<b.scrollSensitivity?e.scrollTop=f=e.scrollTop+b.scrollSpeed:a.pageY-c.overflowOffset.top<b.scrollSensitivity&&(e.scrollTop=f=e.scrollTop-b.scrollSpeed);if(!b.axis||"y"!==b.axis)c.overflowOffset.left+e.offsetWidth-a.pageX<b.scrollSensitivity?e.scrollLeft=f=e.scrollLeft+b.scrollSpeed:a.pageX-c.overflowOffset.left<b.scrollSensitivity&&(e.scrollLeft=f=e.scrollLeft-b.scrollSpeed)}else{if(!b.axis||"x"!==b.axis)a.pageY-d(g).scrollTop()<b.scrollSensitivity?f=d(g).scrollTop(d(g).scrollTop()-
b.scrollSpeed):d(window).height()-(a.pageY-d(g).scrollTop())<b.scrollSensitivity&&(f=d(g).scrollTop(d(g).scrollTop()+b.scrollSpeed));if(!b.axis||"y"!==b.axis)a.pageX-d(g).scrollLeft()<b.scrollSensitivity?f=d(g).scrollLeft(d(g).scrollLeft()-b.scrollSpeed):d(window).width()-(a.pageX-d(g).scrollLeft())<b.scrollSensitivity&&(f=d(g).scrollLeft(d(g).scrollLeft()+b.scrollSpeed))}!1!==f&&(d.ui.ddmanager&&!b.dropBehaviour)&&d.ui.ddmanager.prepareOffsets(c,a)}});d.ui.plugin.add("draggable","snap",{start:function(a,
b,c){a=c.options;c.snapElements=[];d(a.snap.constructor!==String?a.snap.items||":data(ui-draggable)":a.snap).each(function(){var a=d(this),b=a.offset();this!==c.element[0]&&c.snapElements.push({item:this,width:a.outerWidth(),height:a.outerHeight(),top:b.top,left:b.left})})},drag:function(a,b,c){var f,e,g,h,k,l,m,n,p,q,u=c.options,t=u.snapTolerance,r=b.offset.left,s=r+c.helperProportions.width,v=b.offset.top,w=v+c.helperProportions.height;for(p=c.snapElements.length-1;0<=p;p--)k=c.snapElements[p].left-
c.margins.left,l=k+c.snapElements[p].width,m=c.snapElements[p].top-c.margins.top,n=m+c.snapElements[p].height,s<k-t||r>l+t||w<m-t||v>n+t||!d.contains(c.snapElements[p].item.ownerDocument,c.snapElements[p].item)?(c.snapElements[p].snapping&&c.options.snap.release&&c.options.snap.release.call(c.element,a,d.extend(c._uiHash(),{snapItem:c.snapElements[p].item})),c.snapElements[p].snapping=!1):("inner"!==u.snapMode&&(f=Math.abs(m-w)<=t,e=Math.abs(n-v)<=t,g=Math.abs(k-s)<=t,h=Math.abs(l-r)<=t,f&&(b.position.top=
c._convertPositionTo("relative",{top:m-c.helperProportions.height,left:0}).top),e&&(b.position.top=c._convertPositionTo("relative",{top:n,left:0}).top),g&&(b.position.left=c._convertPositionTo("relative",{top:0,left:k-c.helperProportions.width}).left),h&&(b.position.left=c._convertPositionTo("relative",{top:0,left:l}).left)),q=f||e||g||h,"outer"!==u.snapMode&&(f=Math.abs(m-v)<=t,e=Math.abs(n-w)<=t,g=Math.abs(k-r)<=t,h=Math.abs(l-s)<=t,f&&(b.position.top=c._convertPositionTo("relative",{top:m,left:0}).top),
e&&(b.position.top=c._convertPositionTo("relative",{top:n-c.helperProportions.height,left:0}).top),g&&(b.position.left=c._convertPositionTo("relative",{top:0,left:k}).left),h&&(b.position.left=c._convertPositionTo("relative",{top:0,left:l-c.helperProportions.width}).left)),!c.snapElements[p].snapping&&(f||e||g||h||q)&&c.options.snap.snap&&c.options.snap.snap.call(c.element,a,d.extend(c._uiHash(),{snapItem:c.snapElements[p].item})),c.snapElements[p].snapping=f||e||g||h||q)}});d.ui.plugin.add("draggable",
...
height:this.element[0].offsetHeight}};this._addToManager(b.scope);b.addClasses&&this._addClass("ui-droppable")},_addToManager:function(a){d.ui.ddmanager.droppables[a]=d.ui.ddmanager.droppables[a]||[];d.ui.ddmanager.droppables[a].push(this)},_splice:function(a){for(var b=0;b<a.length;b++)a[b]===this&&a.splice(b,1)},_destroy:function(){this._splice(d.ui.ddmanager.droppables[this.options.scope])},_setOption:function(a,b){"accept"===a?this.accept="function"===typeof b?b:function(a){return a.is(b)}:"scope"===
a&&(this._splice(d.ui.ddmanager.droppables[this.options.scope]),this._addToManager(b));this._super(a,b)},_activate:function(a){var b=d.ui.ddmanager.current;this._addActiveClass();b&&this._trigger("activate",a,this.ui(b))},_deactivate:function(a){var b=d.ui.ddmanager.current;this._removeActiveClass();b&&this._trigger("deactivate",a,this.ui(b))},_over:function(a){var b=d.ui.ddmanager.current;if(b&&(b.currentItem||b.element)[0]!==this.element[0])if(this.accept.call(this.element[0],b.currentItem||b.element))this._addHoverClass(),
...
a.helperProportions.height,l=b.offset.left,m=b.offset.top,n=l+b.proportions().width,p=m+b.proportions().height;switch(c){case "fit":return l<=e&&h<=n&&m<=g&&k<=p;case "intersect":return l<e+a.helperProportions.width/2&&h-a.helperProportions.width/2<n&&m<g+a.helperProportions.height/2&&k-a.helperProportions.height/2<p;case "pointer":a=d.pageY;c=b.proportions().height;if(m=a>=m&&a<m+c)d=d.pageX,b=b.proportions().width,m=d>=l&&d<l+b;return m;case "touch":return(g>=m&&g<=p||k>=m&&k<=p||g<m&&k>p)&&(e>=
l&&e<=n||h>=l&&h<=n||e<l&&h>n);default:return!1}}}();d.ui.ddmanager={current:null,droppables:{"default":[]},prepareOffsets:function(a,b){var c,f,e=d.ui.ddmanager.droppables[a.options.scope]||[],g=b?b.type:null,h=(a.currentItem||a.element).find(":data(ui-droppable)").addBack();c=0;a:for(;c<e.length;c++)if(!(e[c].options.disabled||a&&!e[c].accept.call(e[c].element[0],a.currentItem||a.element))){for(f=0;f<h.length;f++)if(h[f]===e[c].element[0]){e[c].proportions().height=0;continue a}e[c].visible="none"!==
e[c].element.css("display");e[c].visible&&("mousedown"===g&&e[c]._activate.call(e[c],b),e[c].offset=e[c].element.offset(),e[c].proportions({width:e[c].element[0].offsetWidth,height:e[c].element[0].offsetHeight}))}},drop:function(a,b){var c=!1;d.each((d.ui.ddmanager.droppables[a.options.scope]||[]).slice(),function(){if(this.options&&(!this.options.disabled&&(this.visible&&d.ui.intersect(a,this,this.options.tolerance,b))&&(c=this._drop.call(this,b)||c),!this.options.disabled&&this.visible&&this.accept.call(this.element[0],
a.currentItem||a.element)))this.isout=!0,this.isover=!1,this._deactivate.call(this,b)});return c},dragStart:function(a,b){a.element.parentsUntil("body").on("scroll.droppable",function(){a.options.refreshPositions||d.ui.ddmanager.prepareOffsets(a,b)})},drag:function(a,b){a.options.refreshPositions&&d.ui.ddmanager.prepareOffsets(a,b);d.each(d.ui.ddmanager.droppables[a.options.scope]||[],function(){if(!this.options.disabled&&!this.greedyChild&&this.visible){var c,f,e;e=d.ui.intersect(a,this,this.options.tolerance,
...
originalElement:this.element,_proportionallyResizeElements:[],_helper:b.helper||b.ghost||b.animate?b.helper||"ui-resizable-helper":null});this.element[0].nodeName.match(/^(canvas|textarea|input|select|button|img)$/i)&&(this.element.wrap(d("<div class='ui-wrapper'></div>").css({overflow:"hidden",position:this.element.css("position"),width:this.element.outerWidth(),height:this.element.outerHeight(),top:this.element.css("top"),left:this.element.css("left")})),this.element=this.element.parent().data("ui-resizable",
...
this.options,b,c,f,e,g,h=this;this.handles=a.handles||(!d(".ui-resizable-handle",this.element).length?"e,s,se":{n:".ui-resizable-n",e:".ui-resizable-e",s:".ui-resizable-s",w:".ui-resizable-w",se:".ui-resizable-se",sw:".ui-resizable-sw",ne:".ui-resizable-ne",nw:".ui-resizable-nw"});this._handles=d();this._addedHandles=d();if(this.handles.constructor===String){"all"===this.handles&&(this.handles="n,e,s,w,se,sw,ne,nw");f=this.handles.split(",");this.handles={};for(c=0;c<f.length;c++)b=String.prototype.trim.call(f[c]),
...
(a.width=b.minWidth);h&&(a.height=b.minHeight);d&&(a.width=b.maxWidth);e&&(a.height=b.maxHeight);g&&m&&(a.left=k-b.minWidth);d&&m&&(a.left=k-b.maxWidth);h&&c&&(a.top=l-b.minHeight);e&&c&&(a.top=l-b.maxHeight);!a.width&&!a.height&&!a.left&&a.top?a.top=null:!a.width&&(!a.height&&!a.top&&a.left)&&(a.left=null);return a},_getPaddingPlusBorderDimensions:function(a){var b=0,c=[],d=[a.css("borderTopWidth"),a.css("borderRightWidth"),a.css("borderBottomWidth"),a.css("borderLeftWidth")];for(a=[a.css("paddingTop"),
...
"ui-selected");c.selecting=!1;c.selected=!0;c.startselected=!0;b._trigger("selected",a,{selected:c.element})});this._trigger("stop",a);this.helper.remove();return!1}});d.widget("ui.sortable",d.ui.mouse,{version:"1.13.2",widgetEventPrefix:"sort",ready:!1,options:{appendTo:"parent",axis:!1,connectWith:!1,containment:!1,cursor:"auto",cursorAt:!1,dropOnEmpty:!0,forcePlaceholderSize:!1,forceHelperSize:!1,grid:!1,handle:!1,helper:"original",items:"> *",opacity:!1,placeholder:!1,revert:!1,scroll:!0,scrollSensitivity:20,
...
this.helper.css("position","absolute");this.cssPosition=this.helper.css("position");b.cursorAt&&this._adjustOffsetFromHelper(b.cursorAt);this.domPosition={prev:this.currentItem.prev()[0],parent:this.currentItem.parent()[0]};this.helper[0]!==this.currentItem[0]&&this.currentItem.hide();this._createPlaceholder();this.scrollParent=this.placeholder.scrollParent();d.extend(this.offset,{parent:this._getParentOffset()});b.containment&&this._setContainment();b.cursor&&"auto"!==b.cursor&&(f=this.document.find("body"),
this.storedCursor=f.css("cursor"),f.css("cursor",b.cursor),this.storedStylesheet=d("<style>*{ cursor: "+b.cursor+" !important; }</style>").appendTo(f));b.zIndex&&(this.helper.css("zIndex")&&(this._storedZIndex=this.helper.css("zIndex")),this.helper.css("zIndex",b.zIndex));b.opacity&&(this.helper.css("opacity")&&(this._storedOpacity=this.helper.css("opacity")),this.helper.css("opacity",b.opacity));this.scrollParent[0]!==this.document[0]&&"HTML"!==this.scrollParent[0].tagName&&(this.overflowOffset=
...
c=this.scrollParent[0].scrollTop+b.scrollSpeed:a.pageY-this.overflowOffset.top<b.scrollSensitivity&&(this.scrollParent[0].scrollTop=c=this.scrollParent[0].scrollTop-b.scrollSpeed),this.overflowOffset.left+this.scrollParent[0].offsetWidth-a.pageX<b.scrollSensitivity?this.scrollParent[0].scrollLeft=c=this.scrollParent[0].scrollLeft+b.scrollSpeed:a.pageX-this.overflowOffset.left<b.scrollSensitivity&&(this.scrollParent[0].scrollLeft=c=this.scrollParent[0].scrollLeft-b.scrollSpeed)):(a.pageY-this.document.scrollTop()<
b.scrollSensitivity?c=this.document.scrollTop(this.document.scrollTop()-b.scrollSpeed):this.window.height()-(a.pageY-this.document.scrollTop())<b.scrollSensitivity&&(c=this.document.scrollTop(this.document.scrollTop()+b.scrollSpeed)),a.pageX-this.document.scrollLeft()<b.scrollSensitivity?c=this.document.scrollLeft(this.document.scrollLeft()-b.scrollSpeed):this.window.width()-(a.pageX-this.document.scrollLeft())<b.scrollSensitivity&&(c=this.document.scrollLeft(this.document.scrollLeft()+b.scrollSpeed)));
return c},_mouseDrag:function(a){var b,c,f,e;b=this.options;this.position=this._generatePosition(a);this.positionAbs=this._convertPositionTo("absolute");if(!this.options.axis||"y"!==this.options.axis)this.helper[0].style.left=this.position.left+"px";if(!this.options.axis||"x"!==this.options.axis)this.helper[0].style.top=this.position.top+"px";b.scroll&&!1!==this._scroll(a)&&(this._refreshItemPositions(!0),d.ui.ddmanager&&!b.dropBehaviour&&d.ui.ddmanager.prepareOffsets(this,a));this.dragDirection=
...
this.options;return a.connectWith.constructor===String?[a.connectWith]:a.connectWith},_getItemsAsjQuery:function(a){function b(){g.push(this)}var c,f,e,g=[],h=[],k=this._connectWith();if(k&&a)for(a=k.length-1;0<=a;a--){f=d(k[a],this.document[0]);for(c=f.length-1;0<=c;c--)(e=d.data(f[c],this.widgetFullName))&&(e!==this&&!e.options.disabled)&&h.push(["function"===typeof e.options.items?e.options.items.call(e.element):d(e.options.items,e.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),
...
_refreshItems:function(a){this.items=[];this.containers=[this];var b,c,f,e,g,h=this.items,k=[["function"===typeof this.options.items?this.options.items.call(this.element[0],a,{item:this.currentItem}):d(this.options.items,this.element),this]];if((g=this._connectWith())&&this.ready)for(b=g.length-1;0<=b;b--){f=d(g[b],this.document[0]);for(c=f.length-1;0<=c;c--)if((e=d.data(f[c],this.widgetFullName))&&e!==this&&!e.options.disabled)k.push(["function"===typeof e.options.items?e.options.items.call(e.element[0],
a,{item:this.currentItem}):d(e.options.items,e.element),e]),this.containers.push(e)}for(b=k.length-1;0<=b;b--){a=k[b][1];f=k[b][0];c=0;for(g=f.length;c<g;c++)e=d(f[c]),e.data(this.widgetName+"-item",a),h.push({item:e,instance:a,width:0,height:0,left:0,top:0})}},_refreshItemPositions:function(a){var b,c,f;for(b=this.items.length-1;0<=b;b--)if(c=this.items[b],!this.currentContainer||!(c.instance!==this.currentContainer&&c.item[0]!==this.currentItem[0]))f=this.options.toleranceElement?d(this.options.toleranceElement,
c.item):c.item,a||(c.width=f.outerWidth(),c.height=f.outerHeight()),f=f.offset(),c.left=f.left,c.top=f.top},refreshPositions:function(a){this.floating=this.items.length?"x"===this.options.axis||this._isFloating(this.items[0].item):!1;this.offsetParent&&this.helper&&(this.offset.parent=this._getParentOffset());this._refreshItemPositions(a);var b;if(this.options.custom&&this.options.custom.refreshContainers)this.options.custom.refreshContainers.call(this);else for(a=this.containers.length-1;0<=a;a--)b=
this.containers[a].element.offset(),this.containers[a].containerCache.left=b.left,this.containers[a].containerCache.top=b.top,this.containers[a].containerCache.width=this.containers[a].element.outerWidth(),this.containers[a].containerCache.height=this.containers[a].element.outerHeight();return this},_createPlaceholder:function(a){a=a||this;var b,c,f=a.options;if(!f.placeholder||f.placeholder.constructor===String)b=f.placeholder,c=a.currentItem[0].nodeName.toLowerCase(),f.placeholder={element:function(){var f=
d("<"+c+">",a.document[0]);a._addClass(f,"ui-sortable-placeholder",b||a.currentItem[0].className)._removeClass(f,"ui-sortable-helper");"tbody"===c?a._createTrPlaceholder(a.currentItem.find("tr").eq(0),d("<tr>",a.document[0]).appendTo(f)):"tr"===c?a._createTrPlaceholder(a.currentItem,f):"img"===c&&f.attr("src",a.currentItem.attr("src"));b||f.css("visibility","hidden");return f},update:function(d,g){if(!b||f.forcePlaceholderSize){if(!g.height()||f.forcePlaceholderSize&&("tbody"===c||"tr"===c))g.height(a.currentItem.innerHeight()-
parseInt(a.currentItem.css("paddingTop")||0,10)-parseInt(a.currentItem.css("paddingBottom")||0,10));g.width()||g.width(a.currentItem.innerWidth()-parseInt(a.currentItem.css("paddingLeft")||0,10)-parseInt(a.currentItem.css("paddingRight")||0,10))}}};a.placeholder=d(f.placeholder.element.call(a.element,a.currentItem));a.currentItem.after(a.placeholder);f.placeholder.update(a,a.placeholder)},_createTrPlaceholder:function(a,b){var c=this;a.children().each(function(){d("<td>&#160;</td>",c.document[0]).attr("colspan",
d(this).attr("colspan")||1).appendTo(b)})},_contactContainers:function(a){var b,c,f,e,g,h,k,l,m=e=null;for(b=this.containers.length-1;0<=b;b--)if(!d.contains(this.currentItem[0],this.containers[b].element[0]))if(this._intersectsWith(this.containers[b].containerCache)){if(!e||!d.contains(this.containers[b].element[0],e.element[0]))e=this.containers[b],m=b}else this.containers[b].containerCache.over&&(this.containers[b]._trigger("out",a,this._uiHash(this)),this.containers[b].containerCache.over=0);
if(e)if(1===this.containers.length)this.containers[m].containerCache.over||(this.containers[m]._trigger("over",a,this._uiHash(this)),this.containers[m].containerCache.over=1);else{b=1E4;f=null;e=(c=e.floating||this._isFloating(this.currentItem))?"left":"top";g=c?"width":"height";l=c?"pageX":"pageY";for(c=this.items.length-1;0<=c;c--)d.contains(this.containers[m].element[0],this.items[c].item[0])&&this.items[c].item[0]!==this.currentItem[0]&&(h=this.items[c].item.offset()[e],k=!1,a[l]-h>this.items[c][g]/
...
a?1:-1,f="absolute"===this.cssPosition&&!(this.scrollParent[0]!==this.document[0]&&d.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,e=/(html|body)/i.test(f[0].tagName);return{top:b.top+this.offset.relative.top*c+this.offset.parent.top*c-("fixed"===this.cssPosition?-this.scrollParent.scrollTop():e?0:f.scrollTop())*c,left:b.left+this.offset.relative.left*c+this.offset.parent.left*c-("fixed"===this.cssPosition?-this.scrollParent.scrollLeft():e?0:f.scrollLeft())*
c}},_generatePosition:function(a){var b,c,f=this.options;c=a.pageX;b=a.pageY;var e="absolute"===this.cssPosition&&!(this.scrollParent[0]!==this.document[0]&&d.contains(this.scrollParent[0],this.offsetParent[0]))?this.offsetParent:this.scrollParent,g=/(html|body)/i.test(e[0].tagName);"relative"===this.cssPosition&&!(this.scrollParent[0]!==this.document[0]&&this.scrollParent[0]!==this.offsetParent[0])&&(this.offset.relative=this._getRelativeOffset());this.originalPosition&&(this.containment&&(a.pageX-
...
d.Widget.prototype._trigger.apply(this,arguments)&&this.cancel()},_uiHash:function(a){var b=a||this;return{helper:b.helper,placeholder:b.placeholder||d([]),position:b.position,originalPosition:b.originalPosition,offset:b.positionAbs,item:b.currentItem,sender:a?a.element:null}}});d.widget("ui.accordion",{version:"1.13.2",options:{active:0,animate:{},classes:{"ui-accordion-header":"ui-corner-top","ui-accordion-header-collapsed":"ui-corner-all","ui-accordion-content":"ui-corner-bottom"},collapsible:!1,
event:"click",header:function(a){return a.find("> li > :first-child").add(a.find("> :not(li)").even())},heightStyle:"auto",icons:{activeHeader:"ui-icon-triangle-1-s",header:"ui-icon-triangle-1-e"},activate:null,beforeActivate:null},hideProps:{borderTopWidth:"hide",borderBottomWidth:"hide",paddingTop:"hide",paddingBottom:"hide",height:"hide"},showProps:{borderTopWidth:"show",borderBottomWidth:"show",paddingTop:"show",paddingBottom:"show",height:"show"},_create:function(){var a=this.options;this.prevShow=
this.prevHide=d();this._addClass("ui-accordion","ui-widget ui-helper-reset");this.element.attr("role","tablist");if(!a.collapsible&&(!1===a.active||null==a.active))a.active=0;this._processPanels();0>a.active&&(a.active+=this.headers.length);this._refresh()},_getCreateEventData:function(){return{header:this.active,panel:!this.active.length?d():this.active.next()}},_createIcons:function(){var a,b=this.options.icons;b&&(a=d("<span>"),this._addClass(a,"ui-accordion-header-icon","ui-icon "+b.header),a.prependTo(this.headers),
a=this.active.children(".ui-accordion-header-icon"),this._removeClass(a,b.header)._addClass(a,null,b.activeHeader)._addClass(this.headers,"ui-accordion-icons"))},_destroyIcons:function(){this._removeClass(this.headers,"ui-accordion-icons");this.headers.children(".ui-accordion-header-icon").remove()},_destroy:function(){var a;this.element.removeAttr("role");this.headers.removeAttr("role aria-expanded aria-selected aria-controls tabIndex").removeUniqueId();this._destroyIcons();a=this.headers.next().css("display",
...
a);this._toggleClass(null,"ui-state-disabled",!!a);this._toggleClass(this.headers.add(this.headers.next()),null,"ui-state-disabled",!!a)},_keydown:function(a){if(!a.altKey&&!a.ctrlKey){var b=d.ui.keyCode,c=this.headers.length,f=this.headers.index(a.target),e=!1;switch(a.keyCode){case b.RIGHT:case b.DOWN:e=this.headers[(f+1)%c];break;case b.LEFT:case b.UP:e=this.headers[(f-1+c)%c];break;case b.SPACE:case b.ENTER:this._eventHandler(a);break;case b.HOME:e=this.headers[0];break;case b.END:e=this.headers[c-
1]}e&&(d(a.target).attr("tabIndex",-1),d(e).attr("tabIndex",0),d(e).trigger("focus"),a.preventDefault())}},_panelKeyDown:function(a){a.keyCode===d.ui.keyCode.UP&&a.ctrlKey&&d(a.currentTarget).prev().trigger("focus")},refresh:function(){var a=this.options;this._processPanels();!1===a.active&&!0===a.collapsible||!this.headers.length?(a.active=!1,this.active=d()):!1===a.active?this._activate(0):this.active.length&&!d.contains(this.element[0],this.active[0])?this.headers.length===this.headers.find(".ui-state-disabled").length?
(a.active=!1,this.active=d()):this._activate(Math.max(0,a.active-1)):a.active=this.headers.index(this.active);this._destroyIcons();this._refresh()},_processPanels:function(){var a=this.headers,b=this.panels;this.headers="function"===typeof this.options.header?this.options.header(this.element):this.element.find(this.options.header);this._addClass(this.headers,"ui-accordion-header ui-accordion-header-collapsed","ui-state-default");this.panels=this.headers.next().filter(":not(.ui-accordion-content-active)").hide();
...
this._setupEvents(b.event);"fill"===c?(a=f.height(),this.element.siblings(":visible").each(function(){var b=d(this),c=b.css("position");"absolute"===c||"fixed"===c||(a-=b.outerHeight(!0))}),this.headers.each(function(){a-=d(this).outerHeight(!0)}),this.headers.next().each(function(){d(this).height(Math.max(0,a-d(this).innerHeight()+d(this).height()))}).css("overflow","auto")):"auto"===c&&(a=0,this.headers.next().each(function(){var b=d(this).is(":visible");b||d(this).show();a=Math.max(a,d(this).css("height",
"").height());b||d(this).hide()}).height(a))},_activate:function(a){a=this._findActive(a)[0];a!==this.active[0]&&(a=a||this.active[0],this._eventHandler({target:a,currentTarget:a,preventDefault:d.noop}))},_findActive:function(a){return"number"===typeof a?this.headers.eq(a):d()},_setupEvents:function(a){var b={keydown:"_keydown"};a&&d.each(a.split(" "),function(a,d){b[d]="_eventHandler"});this._off(this.headers.add(this.headers.next()));this._on(this.headers,b);this._on(this.headers.next(),{keydown:"_panelKeyDown"});
...
null,a)}});d.widget("ui.menu",{version:"1.13.2",defaultElement:"<ul>",delay:300,options:{icons:{submenu:"ui-icon-caret-1-e"},items:"> *",menus:"ul",position:{my:"left top",at:"right top"},role:"menu",blur:null,focus:null,select:null},_create:function(){this.activeMenu=this.element;this.mouseHandled=!1;this.lastMousePosition={x:null,y:null};this.element.uniqueId().attr({role:this.options.role,tabIndex:0});this._addClass("ui-menu","ui-widget ui-widget-content");this._on({"mousedown .ui-menu-item":function(a){a.preventDefault();
this._activateItem(a)},"click .ui-menu-item":function(a){var b=d(a.target),c=d(d.ui.safeActiveElement(this.document[0]));!this.mouseHandled&&b.not(".ui-state-disabled").length&&(this.select(a),a.isPropagationStopped()||(this.mouseHandled=!0),b.has(".ui-menu").length?this.expand(a):!this.element.is(":focus")&&c.closest(".ui-menu").length&&(this.element.trigger("focus",[!0]),this.active&&1===this.active.parents(".ui-menu").length&&clearTimeout(this.timer)))},"mouseenter .ui-menu-item":"_activateItem",
...
"ui-selectmenu-button-closed":""},first:{"ui-selectmenu-button-open":"ui-corner-"+(b?"top":"tl"),"ui-selectmenu-button-closed":"ui-corner-"+(b?"top":"left")},last:{"ui-selectmenu-button-open":b?"":"ui-corner-tr","ui-selectmenu-button-closed":"ui-corner-"+(b?"bottom":"right")},only:{"ui-selectmenu-button-open":"ui-corner-top","ui-selectmenu-button-closed":"ui-corner-all"}}[a]}},_resolveClassesValues:function(a,b){var c={};d.each(a,function(d){var e=b.options.classes[d]||"",e=String.prototype.trim.call(e.replace(la,
...
a+" and element.type="+this.type)},_enhance:function(){this._updateIcon(this.element[0].checked)},widget:function(){return this.label},_getRadioGroup:function(){var a=this.element[0].name,b="input[name='"+d.escapeSelector(a)+"']";return!a?d([]):(this.form.length?d(this.form[0].elements).filter(b):d(b).filter(function(){return 0===d(this)._form().length})).not(this.element)},_toggleClasses:function(){var a=this.element[0].checked;this._toggleClass(this.label,"ui-checkboxradio-checked","ui-state-active",
...
!this.options.showLabel&&!this.title&&this.element.attr("title",this.options.label)},_updateIcon:function(a,b){var c="iconPosition"!==a,f=c?this.options.iconPosition:b,e="top"===f||"bottom"===f;this.icon?c&&this._removeClass(this.icon,null,this.options.icon):(this.icon=d("<span>"),this._addClass(this.icon,"ui-button-icon","ui-icon"),this.options.showLabel||this._addClass("ui-button-icon-only"));c&&this._addClass(this.icon,null,b);this._attachIcon(f);e?(this._addClass(this.icon,null,"ui-widget-icon-block"),
this.iconSpace&&this.iconSpace.remove()):(this.iconSpace||(this.iconSpace=d("<span> </span>"),this._addClass(this.iconSpace,"ui-button-icon-space")),this._removeClass(this.icon,null,"ui-wiget-icon-block"),this._attachIconSpace(f))},_destroy:function(){this.element.removeAttr("role");this.icon&&this.icon.remove();this.iconSpace&&this.iconSpace.remove();this.hasTitle||this.element.removeAttr("title")},_attachIconSpace:function(a){this.icon[/^(?:end|bottom)/.test(a)?"before":"after"](this.iconSpace)},
_attachIcon:function(a){this.element[/^(?:end|bottom)/.test(a)?"append":"prepend"](this.icon)},_setOptions:function(a){var b=void 0===a.icon?this.options.icon:a.icon;if(!(void 0===a.showLabel?this.options.showLabel:a.showLabel)&&!b)a.showLabel=!0;this._super(a)},_setOption:function(a,b){"icon"===a&&(b?this._updateIcon(a,b):this.icon&&(this.icon.remove(),this.iconSpace&&this.iconSpace.remove()));"iconPosition"===a&&this._updateIcon(a,b);"showLabel"===a&&(this._toggleClass("ui-button-icon-only",null,
...
this._updateTooltip()}});!1!==d.uiBackCompat&&(d.widget("ui.button",d.ui.button,{options:{text:!0,icons:{primary:null,secondary:null}},_create:function(){this.options.showLabel&&!this.options.text&&(this.options.showLabel=this.options.text);!this.options.showLabel&&this.options.text&&(this.options.text=this.options.showLabel);!this.options.icon&&(this.options.icons.primary||this.options.icons.secondary)?this.options.icons.primary?this.options.icon=this.options.icons.primary:(this.options.icon=this.options.icons.secondary,
this.options.iconPosition="end"):this.options.icon&&(this.options.icons.primary=this.options.icon);this._super()},_setOption:function(a,b){"text"===a?this._super("showLabel",b):("showLabel"===a&&(this.options.text=b),"icon"===a&&(this.options.icons.primary=b),"icons"===a&&(b.primary?(this._super("icon",b.primary),this._super("iconPosition","beginning")):b.secondary&&(this._super("icon",b.secondary),this._super("iconPosition","end"))),this._superApply(arguments))}}),d.fn.button=function(a){return function(b){var c=
"string"===typeof b,f=Array.prototype.slice.call(arguments,1),e=this;c?!this.length&&"instance"===b?e=void 0:this.each(function(){var a;a=d(this).attr("type");var c=d.data(this,"ui-"+("checkbox"!==a&&"radio"!==a?"button":"checkboxradio"));if("instance"===b)return e=c,!1;if(!c)return d.error("cannot call methods on button prior to initialization; attempted to call method '"+b+"'");if("function"!==typeof c[b]||"_"===b.charAt(0))return d.error("no such method '"+b+"' for button widget instance");a=c[b].apply(c,
f);if(a!==c&&void 0!==a)return e=a&&a.jquery?e.pushStack(a.get()):a,!1}):(f.length&&(b=d.widget.extend.apply(null,[b].concat(f))),this.each(function(){var c=d(this).attr("type"),c="checkbox"!==c&&"radio"!==c?"button":"checkboxradio",f=d.data(this,"ui-"+c);f?(f.option(b||{}),f._init&&f._init()):"button"===c?a.call(d(this),b):d(this).checkboxradio(d.extend({icon:!1},b))}));return e}}(d.fn.button),d.fn.buttonset=function(){d.ui.controlgroup||d.error("Controlgroup widget missing");if("option"===arguments[0]&&
"items"===arguments[1]&&arguments[2])return this.controlgroup.apply(this,[arguments[0],"items.button",arguments[2]]);if("option"===arguments[0]&&"items"===arguments[1])return this.controlgroup.apply(this,[arguments[0],"items.button"]);"object"===typeof arguments[0]&&arguments[0].items&&(arguments[0].items={button:arguments[0].items});return this.controlgroup.apply(this,arguments)});d.extend(d.ui,{datepicker:{version:"1.13.2"}});var H;d.extend(W.prototype,{markerClassName:"hasDatepicker",maxRows:4,
_widgetDatepicker:function(){return this.dpDiv},setDefaults:function(a){P(this._defaults,a||{});return this},_attachDatepicker:function(a,b){var c,f,e;c=a.nodeName.toLowerCase();f="div"===c||"span"===c;a.id||(this.uuid+=1,a.id="dp"+this.uuid);e=this._newInst(d(a),f);e.settings=d.extend({},b||{});"input"===c?this._connectDatepicker(a,e):f&&this._inlineDatepicker(a,e)},_newInst:function(a,b){return{id:a[0].id.replace(/([^A-Za-z0-9_\-])/g,"\\\\$1"),input:a,selectedDay:0,selectedMonth:0,selectedYear:0,
drawMonth:0,drawYear:0,inline:b,dpDiv:!b?this.dpDiv:X(d("<div class='"+this._inlineClass+" ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))}},_connectDatepicker:function(a,b){var c=d(a);b.append=d([]);b.trigger=d([]);c.hasClass(this.markerClassName)||(this._attachments(c,b),c.addClass(this.markerClassName).on("keydown",this._doKeyDown).on("keypress",this._doKeyPress).on("keyup",this._doKeyUp),this._autoSize(b),d.data(a,"datepicker",b),b.settings.disabled&&this._disableDatepicker(a))},
_attachments:function(a,b){var c,f;c=this._get(b,"appendText");var e=this._get(b,"isRTL");b.append&&b.append.remove();c&&(b.append=d("<span>").addClass(this._appendClass).text(c),a[e?"before":"after"](b.append));a.off("focus",this._showDatepicker);b.trigger&&b.trigger.remove();c=this._get(b,"showOn");if("focus"===c||"both"===c)a.on("focus",this._showDatepicker);if("button"===c||"both"===c)c=this._get(b,"buttonText"),f=this._get(b,"buttonImage"),this._get(b,"buttonImageOnly")?b.trigger=d("<img>").addClass(this._triggerClass).attr({src:f,
...
d.data(a,"datepicker",b),this._setDate(b,this._getDefaultDate(b),!0),this._updateDatepicker(b),this._updateAlternate(b),b.settings.disabled&&this._disableDatepicker(a),b.dpDiv.css("display","block"))},_dialogDatepicker:function(a,b,c,f,e){var g;a=this._dialogInst;a||(this.uuid+=1,a="dp"+this.uuid,this._dialogInput=d("<input type='text' id='"+a+"' style='position: absolute; top: -100px; width: 0px;'/>"),this._dialogInput.on("keydown",this._doKeyDown),d("body").append(this._dialogInput),a=this._dialogInst=
this._newInst(this._dialogInput,!1),a.settings={},d.data(this._dialogInput[0],"datepicker",a));P(a.settings,f||{});b=b&&b.constructor===Date?this._formatDate(a,b):b;this._dialogInput.val(b);this._pos=e?e.length?e:[e.pageX,e.pageY]:null;this._pos||(b=document.documentElement.clientWidth,f=document.documentElement.clientHeight,e=document.documentElement.scrollLeft||document.body.scrollLeft,g=document.documentElement.scrollTop||document.body.scrollTop,this._pos=[b/2-100+e,f/2-150+g]);this._dialogInput.css("left",
this._pos[0]+20+"px").css("top",this._pos[1]+"px");a.settings.onSelect=c;this._inDialog=!0;this.dpDiv.addClass(this._dialogClass);this._showDatepicker(this._dialogInput[0]);d.blockUI&&d.blockUI(this.dpDiv);d.data(this._dialogInput[0],"datepicker",a);return this},_destroyDatepicker:function(a){var b,c=d(a),f=d.data(a,"datepicker");c.hasClass(this.markerClassName)&&(b=a.nodeName.toLowerCase(),d.removeData(a,"datepicker"),"input"===b?(f.append.remove(),f.trigger.remove(),c.removeClass(this.markerClassName).off("focus",
this._showDatepicker).off("keydown",this._doKeyDown).off("keypress",this._doKeyPress).off("keyup",this._doKeyUp)):("div"===b||"span"===b)&&c.removeClass(this.markerClassName).empty(),H===f&&(this._curInst=H=null))},_enableDatepicker:function(a){var b,c=d(a),f=d.data(a,"datepicker");if(c.hasClass(this.markerClassName)){b=a.nodeName.toLowerCase();if("input"===b)a.disabled=!1,f.trigger.filter("button").each(function(){this.disabled=!1}).end().filter("img").css({opacity:"1.0",cursor:""});else if("div"===
b||"span"===b)b=c.children("."+this._inlineClass),b.children().removeClass("ui-state-disabled"),b.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled",!1);this._disabledInputs=d.map(this._disabledInputs,function(b){return b===a?null:b})}},_disableDatepicker:function(a){var b,c=d(a),f=d.data(a,"datepicker");if(c.hasClass(this.markerClassName)){b=a.nodeName.toLowerCase();if("input"===b)a.disabled=!0,f.trigger.filter("button").each(function(){this.disabled=!0}).end().filter("img").css({opacity:"0.5",
cursor:"default"});else if("div"===b||"span"===b)b=c.children("."+this._inlineClass),b.children().addClass("ui-state-disabled"),b.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled",!0);this._disabledInputs=d.map(this._disabledInputs,function(b){return b===a?null:b});this._disabledInputs[this._disabledInputs.length]=a}},_isDisabledDatepicker:function(a){if(!a)return!1;for(var b=0;b<this._disabledInputs.length;b++)if(this._disabledInputs[b]===a)return!0;return!1},_getInst:function(a){try{return d.data(a,
"datepicker")}catch(b){throw"Missing instance data for this datepicker";}},_optionDatepicker:function(a,b,c){var f,e,g,h,k=this._getInst(a);if(2===arguments.length&&"string"===typeof b)return"defaults"===b?d.extend({},d.datepicker._defaults):k?"all"===b?d.extend({},k.settings):this._get(k,b):null;f=b||{};"string"===typeof b&&(f={},f[b]=c);k&&(this._curInst===k&&this._hideDatepicker(),e=this._getDateDatepicker(a,!0),g=this._getMinMaxDate(k,"min"),h=this._getMinMaxDate(k,"max"),P(k.settings,f),null!==
...
d.datepicker._curInst!==b&&(d.datepicker._curInst.dpDiv.stop(!0,!0),b&&d.datepicker._datepickerShowing&&d.datepicker._hideDatepicker(d.datepicker._curInst.input[0]));c=(c=d.datepicker._get(b,"beforeShow"))?c.apply(a,[a,b]):{};if(!1!==c&&(P(b.settings,c),b.lastVal=null,d.datepicker._lastInput=a,d.datepicker._setDateFromField(b),d.datepicker._inDialog&&(a.value=""),d.datepicker._pos||(d.datepicker._pos=d.datepicker._findPos(a),d.datepicker._pos[1]+=a.offsetHeight),f=!1,d(a).parents().each(function(){f|=
...
ea(d(a))+1);d.datepicker._datepickerShowing=!0;if(d.effects&&d.effects.effect[c])b.dpDiv.show(c,d.datepicker._get(b,"showOptions"),e);else b.dpDiv[c||"show"](c?e:null);d.datepicker._shouldFocusInput(b)&&b.input.trigger("focus");d.datepicker._curInst=b}}},_updateDatepicker:function(a){this.maxRows=4;H=a;a.dpDiv.empty().append(this._generateHTML(a));this._attachHandlers(a);var b,c=this._getNumberOfMonths(a),f=c[1],e=a.dpDiv.find("."+this._dayOverClass+" a"),g=d.datepicker._get(a,"onUpdateDatepicker");
0<e.length&&Y.apply(e.get(0));a.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width("");1<f&&a.dpDiv.addClass("ui-datepicker-multi-"+f).css("width",17*f+"em");a.dpDiv[(1!==c[0]||1!==c[1]?"add":"remove")+"Class"]("ui-datepicker-multi");a.dpDiv[(this._get(a,"isRTL")?"add":"remove")+"Class"]("ui-datepicker-rtl");a===d.datepicker._curInst&&(d.datepicker._datepickerShowing&&d.datepicker._shouldFocusInput(a))&&a.input.trigger("focus");a.yearshtml&&(b=a.yearshtml,
setTimeout(function(){b===a.yearshtml&&a.yearshtml&&a.dpDiv.find("select.ui-datepicker-year").first().replaceWith(a.yearshtml);b=a.yearshtml=null},0));g&&g.apply(a.input?a.input[0]:null,[a])},_shouldFocusInput:function(a){return a.input&&a.input.is(":visible")&&!a.input.is(":disabled")&&!a.input.is(":focus")},_checkOffset:function(a,b,c){var f=a.dpDiv.outerWidth(),e=a.dpDiv.outerHeight(),g=a.input?a.input.outerWidth():0,h=a.input?a.input.outerHeight():0,k=document.documentElement.clientWidth+(c?0:
d(document).scrollLeft()),l=document.documentElement.clientHeight+(c?0:d(document).scrollTop());b.left-=this._get(a,"isRTL")?f-g:0;b.left-=c&&b.left===a.input.offset().left?d(document).scrollLeft():0;b.top-=c&&b.top===a.input.offset().top+h?d(document).scrollTop():0;b.left-=Math.min(b.left,b.left+f>k&&k>f?Math.abs(b.left+f-k):0);b.top-=Math.min(b.top,b.top+e>l&&l>e?Math.abs(e+h):0);return b},_findPos:function(a){for(var b=this._getInst(a),b=this._get(b,"isRTL");a&&("hidden"===a.type||1!==a.nodeType||
d.expr.pseudos.hidden(a));)a=a[b?"previousSibling":"nextSibling"];a=d(a).offset();return[a.left,a.top]},_hideDatepicker:function(a){var b,c,f=this._curInst;if(f&&!(a&&f!==d.data(a,"datepicker"))&&this._datepickerShowing){a=this._get(f,"showAnim");b=this._get(f,"duration");c=function(){d.datepicker._tidyDialog(f)};if(d.effects&&(d.effects.effect[a]||d.effects[a]))f.dpDiv.hide(a,d.datepicker._get(f,"showOptions"),b,c);else f.dpDiv["slideDown"===a?"slideUp":"fadeIn"===a?"fadeOut":"hide"](a?b:null,c);
a||c();this._datepickerShowing=!1;(a=this._get(f,"onClose"))&&a.apply(f.input?f.input[0]:null,[f.input?f.input.val():"",f]);this._lastInput=null;this._inDialog&&(this._dialogInput.css({position:"absolute",left:"0",top:"-100px"}),d.blockUI&&(d.unblockUI(),d("body").append(this.dpDiv)));this._inDialog=!1}},_tidyDialog:function(a){a.dpDiv.removeClass(this._dialogClass).off(".ui-datepicker-calendar")},_checkExternalClick:function(a){if(d.datepicker._curInst){a=d(a.target);var b=d.datepicker._getInst(a[0]);
(a[0].id!==d.datepicker._mainDivId&&0===a.parents("#"+d.datepicker._mainDivId).length&&!a.hasClass(d.datepicker.markerClassName)&&!a.closest("."+d.datepicker._triggerClass).length&&d.datepicker._datepickerShowing&&(!d.datepicker._inDialog||!d.blockUI)||a.hasClass(d.datepicker.markerClassName)&&d.datepicker._curInst!==b)&&d.datepicker._hideDatepicker()}},_adjustDate:function(a,b,c){a=d(a);var f=this._getInst(a[0]);this._isDisabledDatepicker(a[0])||(this._adjustInstDate(f,b,c),this._updateDatepicker(f))},
_gotoToday:function(a){var b=d(a),c=this._getInst(b[0]);this._get(c,"gotoCurrent")&&c.currentDay?(c.selectedDay=c.currentDay,c.drawMonth=c.selectedMonth=c.currentMonth,c.drawYear=c.selectedYear=c.currentYear):(a=new Date,c.selectedDay=a.getDate(),c.drawMonth=c.selectedMonth=a.getMonth(),c.drawYear=c.selectedYear=a.getFullYear());this._notifyChange(c);this._adjustDate(b)},_selectMonthYear:function(a,b,c){a=d(a);var f=this._getInst(a[0]);f["selected"+("M"===c?"Month":"Year")]=f["draw"+("M"===c?"Month":
"Year")]=parseInt(b.options[b.selectedIndex].value,10);this._notifyChange(f);this._adjustDate(a)},_selectDay:function(a,b,c,f){var e;e=d(a);!d(f).hasClass(this._unselectableClass)&&!this._isDisabledDatepicker(e[0])&&(e=this._getInst(e[0]),e.selectedDay=e.currentDay=parseInt(d("a",f).attr("data-date")),e.selectedMonth=e.currentMonth=b,e.selectedYear=e.currentYear=c,this._selectDate(a,this._formatDate(e,e.currentDay,e.currentMonth,e.currentYear)))},_clearDate:function(a){a=d(a);this._selectDate(a,"")},
_selectDate:function(a,b){var c;c=d(a);var f=this._getInst(c[0]);b=null!=b?b:this._formatDate(f);f.input&&f.input.val(b);this._updateAlternate(f);(c=this._get(f,"onSelect"))?c.apply(f.input?f.input[0]:null,[b,f]):f.input&&f.input.trigger("change");f.inline?this._updateDatepicker(f):(this._hideDatepicker(),this._lastInput=f.input[0],"object"!==typeof f.input[0]&&f.input.trigger("focus"),this._lastInput=null)},_updateAlternate:function(a){var b,c,f=this._get(a,"altField");f&&(b=this._get(a,"altFormat")||
this._get(a,"dateFormat"),c=this._getDate(a),a=this.formatDate(b,c,this._getFormatConfig(a)),d(document).find(f).val(a))},noWeekends:function(a){a=a.getDay();return[0<a&&6>a,""]},iso8601Week:function(a){var b=new Date(a.getTime());b.setDate(b.getDate()+4-(b.getDay()||7));a=b.getTime();b.setMonth(0);b.setDate(1);return Math.floor(Math.round((a-b)/864E5)/7)+1},parseDate:function(a,b,c){if(null==a||null==b)throw"Invalid arguments";b="object"===typeof b?b.toString():b+"";if(""===b)return null;var f,e,
g,h=0;e=(c?c.shortYearCutoff:null)||this._defaults.shortYearCutoff;e="string"!==typeof e?e:(new Date).getFullYear()%100+parseInt(e,10);g=(c?c.dayNamesShort:null)||this._defaults.dayNamesShort;var k=(c?c.dayNames:null)||this._defaults.dayNames,l=(c?c.monthNamesShort:null)||this._defaults.monthNamesShort,m=(c?c.monthNames:null)||this._defaults.monthNames,n=c=-1,p=-1,q=-1,u=!1,t,r=function(b){(b=f+1<a.length&&a.charAt(f+1)===b)&&f++;return b},s=function(a){var c=r(a),c="@"===a?14:"!"===a?20:"y"===a&&
c?4:"o"===a?3:2;a=RegExp("^\\d{"+("y"===a?c:1)+","+c+"}");a=b.substring(h).match(a);if(!a)throw"Missing number at position "+h;h+=a[0].length;return parseInt(a[0],10)},v=function(a,c,f){var e=-1;a=d.map(r(a)?f:c,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)});d.each(a,function(a,c){var d=c[1];if(b.substr(h,d.length).toLowerCase()===d.toLowerCase())return e=c[0],h+=d.length,!1});if(-1!==e)return e+1;throw"Unknown name at position "+h;},w=function(){if(b.charAt(h)!==
a.charAt(f))throw"Unexpected literal at position "+h;h++};for(f=0;f<a.length;f++)if(u)"'"===a.charAt(f)&&!r("'")?u=!1:w();else switch(a.charAt(f)){case "d":p=s("d");break;case "D":v("D",g,k);break;case "o":q=s("o");break;case "m":n=s("m");break;case "M":n=v("M",l,m);break;case "y":c=s("y");break;case "@":t=new Date(s("@"));c=t.getFullYear();n=t.getMonth()+1;p=t.getDate();break;case "!":t=new Date((s("!")-this._ticksTo1970)/1E4);c=t.getFullYear();n=t.getMonth()+1;p=t.getDate();break;case "'":r("'")?
...
var k=function(b){(b=d+1<a.length&&a.charAt(d+1)===b)&&d++;return b},l=function(a,b,c){b=""+b;if(k(a))for(;b.length<c;)b="0"+b;return b},m=function(a,b,c,d){return k(a)?d[b]:c[b]},n="",p=!1;if(b)for(d=0;d<a.length;d++)if(p)"'"===a.charAt(d)&&!k("'")?p=!1:n+=a.charAt(d);else switch(a.charAt(d)){case "d":n+=l("d",b.getDate(),2);break;case "D":n+=m("D",b.getDay(),e,g);break;case "o":n+=l("o",Math.round(((new Date(b.getFullYear(),b.getMonth(),b.getDate())).getTime()-(new Date(b.getFullYear(),0,0)).getTime())/
...
this,"M");return!1},selectYear:function(){d.datepicker._selectMonthYear(c,this,"Y");return!1}}[this.getAttribute("data-handler")])})},_generateHTML:function(a){var b,c,f,e,g,h,k,l,m,n,p,q,u,t,r,s,v,w,x,B,E,y,z,D,F,H,I,M=new Date,M=this._daylightSavingAdjust(new Date(M.getFullYear(),M.getMonth(),M.getDate())),K=this._get(a,"isRTL");k=this._get(a,"showButtonPanel");f=this._get(a,"hideIfNoPrevNext");h=this._get(a,"navigationAsDateFormat");var L=this._getNumberOfMonths(a),A=this._get(a,"showCurrentAtPos");
e=this._get(a,"stepMonths");var C=1!==L[0]||1!==L[1],J=this._daylightSavingAdjust(!a.currentDay?new Date(9999,9,9):new Date(a.currentYear,a.currentMonth,a.currentDay)),O=this._getMinMaxDate(a,"min"),N=this._getMinMaxDate(a,"max"),A=a.drawMonth-A,G=a.drawYear;0>A&&(A+=12,G--);if(N){b=this._daylightSavingAdjust(new Date(N.getFullYear(),N.getMonth()-L[0]*L[1]+1,N.getDate()));for(b=O&&b<O?O:b;this._daylightSavingAdjust(new Date(G,A,1))>b;)A--,0>A&&(A=11,G--)}a.drawMonth=A;a.drawYear=G;b=this._get(a,"prevText");
b=!h?b:this.formatDate(b,this._daylightSavingAdjust(new Date(G,A-e,1)),this._getFormatConfig(a));b=this._canAdjustMonth(a,-1,G,A)?d("<a>").attr({"class":"ui-datepicker-prev ui-corner-all","data-handler":"prev","data-event":"click",title:b}).append(d("<span>").addClass("ui-icon ui-icon-circle-triangle-"+(K?"e":"w")).text(b))[0].outerHTML:f?"":d("<a>").attr({"class":"ui-datepicker-prev ui-corner-all ui-state-disabled",title:b}).append(d("<span>").addClass("ui-icon ui-icon-circle-triangle-"+(K?"e":"w")).text(b))[0].outerHTML;
c=this._get(a,"nextText");c=!h?c:this.formatDate(c,this._daylightSavingAdjust(new Date(G,A+e,1)),this._getFormatConfig(a));f=this._canAdjustMonth(a,1,G,A)?d("<a>").attr({"class":"ui-datepicker-next ui-corner-all","data-handler":"next","data-event":"click",title:c}).append(d("<span>").addClass("ui-icon ui-icon-circle-triangle-"+(K?"w":"e")).text(c))[0].outerHTML:f?"":d("<a>").attr({"class":"ui-datepicker-next ui-corner-all ui-state-disabled",title:c}).append(d("<span>").attr("class","ui-icon ui-icon-circle-triangle-"+
(K?"w":"e")).text(c))[0].outerHTML;e=this._get(a,"currentText");c=this._get(a,"gotoCurrent")&&a.currentDay?J:M;e=!h?e:this.formatDate(e,c,this._getFormatConfig(a));g="";a.inline||(g=d("<button>").attr({type:"button","class":"ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all","data-handler":"hide","data-event":"click"}).text(this._get(a,"closeText"))[0].outerHTML);h="";k&&(h=d("<div class='ui-datepicker-buttonpane ui-widget-content'>").append(K?g:"").append(this._isInRange(a,c)?
d("<button>").attr({type:"button","class":"ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all","data-handler":"today","data-event":"click"}).text(e):"").append(K?"":g)[0].outerHTML);k=parseInt(this._get(a,"firstDay"),10);k=isNaN(k)?0:k;e=this._get(a,"showWeek");c=this._get(a,"dayNames");g=this._get(a,"dayNamesMin");l=this._get(a,"monthNames");m=this._get(a,"monthNamesShort");n=this._get(a,"beforeShowDay");p=this._get(a,"showOtherMonths");q=this._get(a,"selectOtherMonths");
u=this._getDefaultDate(a);t="";for(s=0;s<L[0];s++){v="";this.maxRows=4;for(w=0;w<L[1];w++){x=this._daylightSavingAdjust(new Date(G,A,a.selectedDay));r=" ui-corner-all";B="";if(C){B+="<div class='ui-datepicker-group";if(1<L[1])switch(w){case 0:B+=" ui-datepicker-group-first";r=" ui-corner-"+(K?"right":"left");break;case L[1]-1:B+=" ui-datepicker-group-last";r=" ui-corner-"+(K?"left":"right");break;default:B+=" ui-datepicker-group-middle",r=""}B+="'>"}B+="<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix"+
r+"'>"+(/all|left/.test(r)&&0===s?K?f:b:"")+(/all|right/.test(r)&&0===s?K?b:f:"")+this._generateMonthYearHeader(a,A,G,O,N,0<s||0<w,l,m)+"</div><table class='ui-datepicker-calendar'><thead><tr>";E=e?"<th class='ui-datepicker-week-col'>"+this._get(a,"weekHeader")+"</th>":"";for(r=0;7>r;r++)y=(r+k)%7,E+="<th scope='col'"+(5<=(r+k+6)%7?" class='ui-datepicker-week-end'":"")+"><span title='"+c[y]+"'>"+g[y]+"</span></th>";B+=E+"</tr></thead><tbody>";E=this._getDaysInMonth(G,A);G===a.selectedYear&&A===a.selectedMonth&&
(a.selectedDay=Math.min(a.selectedDay,E));r=(this._getFirstDayOfMonth(G,A)-k+7)%7;E=Math.ceil((r+E)/7);this.maxRows=E=C?this.maxRows>E?this.maxRows:E:E;y=this._daylightSavingAdjust(new Date(G,A,1-r));for(z=0;z<E;z++){B+="<tr>";D=!e?"":"<td class='ui-datepicker-week-col'>"+this._get(a,"calculateWeek")(y)+"</td>";for(r=0;7>r;r++)F=n?n.apply(a.input?a.input[0]:null,[y]):[!0,""],I=(H=y.getMonth()!==A)&&!q||!F[0]||O&&y<O||N&&y>N,D+="<td class='"+(5<=(r+k+6)%7?" ui-datepicker-week-end":"")+(H?" ui-datepicker-other-month":
"")+(y.getTime()===x.getTime()&&A===a.selectedMonth&&a._keyEvent||u.getTime()===y.getTime()&&u.getTime()===x.getTime()?" "+this._dayOverClass:"")+(I?" "+this._unselectableClass+" ui-state-disabled":"")+(H&&!p?"":" "+F[1]+(y.getTime()===J.getTime()?" "+this._currentClass:"")+(y.getTime()===M.getTime()?" ui-datepicker-today":""))+"'"+((!H||p)&&F[2]?" title='"+F[2].replace(/'/g,"&#39;")+"'":"")+(I?"":" data-handler='selectDay' data-event='click' data-month='"+y.getMonth()+"' data-year='"+y.getFullYear()+
"'")+">"+(H&&!p?"&#xa0;":I?"<span class='ui-state-default'>"+y.getDate()+"</span>":"<a class='ui-state-default"+(y.getTime()===M.getTime()?" ui-state-highlight":"")+(y.getTime()===J.getTime()?" ui-state-active":"")+(H?" ui-priority-secondary":"")+"' href='#' aria-current='"+(y.getTime()===J.getTime()?"true":"false")+"' data-date='"+y.getDate()+"'>"+y.getDate()+"</a>")+"</td>",y.setDate(y.getDate()+1),y=this._daylightSavingAdjust(y);B+=D+"</tr>"}A++;11<A&&(A=0,G++);B+="</tbody></table>"+(C?"</div>"+
(0<L[0]&&w===L[1]-1?"<div class='ui-datepicker-row-break'></div>":""):"");v+=B}t+=v}a._keyEvent=!1;return t+h},_generateMonthYearHeader:function(a,b,c,d,e,g,h,k){var l,m,n,p=this._get(a,"changeMonth"),q=this._get(a,"changeYear"),u=this._get(a,"showMonthAfterYear");m=this._get(a,"selectMonthLabel");var t=this._get(a,"selectYearLabel"),r="<div class='ui-datepicker-title'>",s="";if(g||!p)s+="<span class='ui-datepicker-month'>"+h[b]+"</span>";else{h=d&&d.getFullYear()===c;l=e&&e.getFullYear()===c;s+=
"<select class='ui-datepicker-month' aria-label='"+m+"' data-handler='selectMonth' data-event='change'>";for(m=0;12>m;m++)if((!h||m>=d.getMonth())&&(!l||m<=e.getMonth()))s+="<option value='"+m+"'"+(m===b?" selected='selected'":"")+">"+k[m]+"</option>";s+="</select>"}u||(r+=s+(g||!p||!q?"&#xa0;":""));if(!a.yearshtml)if(a.yearshtml="",g||!q)r+="<span class='ui-datepicker-year'>"+c+"</span>";else{k=this._get(a,"yearRange").split(":");n=(new Date).getFullYear();h=function(a){a=a.match(/c[+\-].*/)?c+parseInt(a.substring(1),
10):a.match(/[+\-].*/)?n+parseInt(a,10):parseInt(a,10);return isNaN(a)?n:a};b=h(k[0]);k=Math.max(b,h(k[1]||""));b=d?Math.max(b,d.getFullYear()):b;k=e?Math.min(k,e.getFullYear()):k;for(a.yearshtml+="<select class='ui-datepicker-year' aria-label='"+t+"' data-handler='selectYear' data-event='change'>";b<=k;b++)a.yearshtml+="<option value='"+b+"'"+(b===c?" selected='selected'":"")+">"+b+"</option>";a.yearshtml+="</select>";r+=a.yearshtml;a.yearshtml=null}r+=this._get(a,"yearSuffix");u&&(r+=(g||!p||!q?
"&#xa0;":"")+s);return r+"</div>"},_adjustInstDate:function(a,b,c){var d=a.selectedYear+("Y"===c?b:0),e=a.selectedMonth+("M"===c?b:0);b=Math.min(a.selectedDay,this._getDaysInMonth(d,e))+("D"===c?b:0);d=this._restrictMinMax(a,this._daylightSavingAdjust(new Date(d,e,b)));a.selectedDay=d.getDate();a.drawMonth=a.selectedMonth=d.getMonth();a.drawYear=a.selectedYear=d.getFullYear();("M"===c||"Y"===c)&&this._notifyChange(a)},_restrictMinMax:function(a,b){var c=this._getMinMaxDate(a,"min"),d=this._getMinMaxDate(a,
...
new W;d.datepicker.initialized=!1;d.datepicker.uuid=(new Date).getTime();d.datepicker.version="1.13.2";d.widget("ui.dialog",{version:"1.13.2",options:{appendTo:"body",autoOpen:!0,buttons:[],classes:{"ui-dialog":"ui-corner-all","ui-dialog-titlebar":"ui-corner-all"},closeOnEscape:!0,closeText:"Close",draggable:!0,hide:null,height:"auto",maxHeight:null,maxWidth:null,minHeight:150,minWidth:150,modal:!1,position:{my:"center",at:"center",of:window,collision:"fit",using:function(a){var b=d(this).css(a).offset().top;
...
d("<div>").hide().attr({tabIndex:-1,role:"dialog"}).appendTo(this._appendTo());this._addClass(this.uiDialog,"ui-dialog","ui-widget ui-widget-content ui-front");this._on(this.uiDialog,{keydown:function(a){if(this.options.closeOnEscape&&!a.isDefaultPrevented()&&a.keyCode&&a.keyCode===d.ui.keyCode.ESCAPE)a.preventDefault(),this.close(a);else if(!(a.keyCode!==d.ui.keyCode.TAB||a.isDefaultPrevented())){var b=this.uiDialog.find(":tabbable"),c=b.first(),f=b.last();if((a.target===f[0]||a.target===this.uiDialog[0])&&
!a.shiftKey)this._delay(function(){c.trigger("focus")}),a.preventDefault();else if((a.target===c[0]||a.target===this.uiDialog[0])&&a.shiftKey)this._delay(function(){f.trigger("focus")}),a.preventDefault()}},mousedown:function(a){this._moveToTop(a)&&this._focusTabbable()}});this.element.find("[aria-describedby]").length||this.uiDialog.attr({"aria-describedby":this.element.uniqueId().attr("id")})},_createTitlebar:function(){var a;this.uiDialogTitlebar=d("<div>");this._addClass(this.uiDialogTitlebar,
...
this._addClass(this.uiButtonSet,"ui-dialog-buttonset");this._createButtons()},_createButtons:function(){var a=this,b=this.options.buttons;this.uiDialogButtonPane.remove();this.uiButtonSet.empty();d.isEmptyObject(b)||Array.isArray(b)&&!b.length?this._removeClass(this.uiDialog,"ui-dialog-buttons"):(d.each(b,function(b,f){var e,g;f="function"===typeof f?{click:f,text:b}:f;f=d.extend({type:"button"},f);e=f.click;g={icon:f.icon,iconPosition:f.iconPosition,showLabel:f.showLabel,icons:f.icons,text:f.text};
delete f.click;delete f.icon;delete f.iconPosition;delete f.showLabel;delete f.icons;"boolean"===typeof f.text&&delete f.text;d("<button></button>",f).button(g).appendTo(a.uiButtonSet).on("click",function(){e.apply(a.element[0],arguments)})}),this._addClass(this.uiDialog,"ui-dialog-buttons"),this.uiDialogButtonPane.appendTo(this.uiDialog))},_makeDraggable:function(){function a(a){return{position:a.position,offset:a.offset}}var b=this,c=this.options;this.uiDialog.draggable({cancel:".ui-dialog-content, .ui-dialog-titlebar-close",
...
"ui-button ui-widget");a=d("<span>").appendTo(this.button);this._addClass(a,"ui-selectmenu-icon","ui-icon "+this.options.icons.button);this.buttonItem=this._renderButtonItem(c).appendTo(this.button);!1!==this.options.width&&this._resizeButton();this._on(this.button,this._buttonEvents);this.button.one("focusin",function(){b._rendered||b._refreshMenu()})},_drawMenu:function(){var a=this;this.menu=d("<ul>",{"aria-hidden":"true","aria-labelledby":this.ids.button,id:this.ids.menu});this.menuWrap=d("<div>").append(this.menu);
...
null,"ui-state-disabled",a);this.element.prop("disabled",a);a?(this.button.attr("tabindex",-1),this.close()):this.button.attr("tabindex",0)},_appendTo:function(){var a=this.options.appendTo;a&&(a=a.jquery||a.nodeType?d(a):this.document.find(a).eq(0));if(!a||!a[0])a=this.element.closest(".ui-front, dialog");a.length||(a=this.document[0].body);return a},_toggleAttr:function(){this.button.attr("aria-expanded",this.isOpen);this._removeClass(this.button,"ui-selectmenu-button-"+(this.isOpen?"closed":"open"))._addClass(this.button,
...
!this.range.length?(this.range=d("<div>").appendTo(this.element),this._addClass(this.range,"ui-slider-range")):(this._removeClass(this.range,"ui-slider-range-min ui-slider-range-max"),this.range.css({left:"",bottom:""})),("min"===a.range||"max"===a.range)&&this._addClass(this.range,"ui-slider-range-"+a.range)):(this.range&&this.range.remove(),this.range=null)},_setupEvents:function(){this._off(this.handles);this._on(this.handles,this._handleEvents);this._hoverable(this.handles);this._focusable(this.handles)},
...
break;case "value":this._animateOff=!0;this._refreshValue();this._change(null,0);this._animateOff=!1;break;case "values":this._animateOff=!0;this._refreshValue();for(c-=1;0<=c;c--)this._change(null,c);this._animateOff=!1;break;case "step":case "min":case "max":this._animateOff=!0;this._calculateNewMax();this._refreshValue();this._animateOff=!1;break;case "range":this._animateOff=!0,this._refresh(),this._animateOff=!1}},_setOptionDisabled:function(a){this._super(a);this._toggleClass(null,"ui-state-disabled",
...
b-1},_valueMin:function(){return this.options.min},_valueMax:function(){return this.max},_refreshRange:function(a){"vertical"===a&&this.range.css({width:"",left:""});"horizontal"===a&&this.range.css({height:"",bottom:""})},_refreshValue:function(){var a,b,c,f,e,g=this.options.range,h=this.options,k=this,l=!this._animateOff?h.animate:!1,m={};if(this._hasMultipleValues())this.handles.each(function(c){b=100*((k.values(c)-k._valueMin())/(k._valueMax()-k._valueMin()));m["horizontal"===k.orientation?"left":
...
b=e!==f?100*((c-f)/(e-f)):0;m["horizontal"===this.orientation?"left":"bottom"]=b+"%";this.handle.stop(1,1)[l?"animate":"css"](m,h.animate);if("min"===g&&"horizontal"===this.orientation)this.range.stop(1,1)[l?"animate":"css"]({width:b+"%"},h.animate);if("max"===g&&"horizontal"===this.orientation)this.range.stop(1,1)[l?"animate":"css"]({width:100-b+"%"},h.animate);if("min"===g&&"vertical"===this.orientation)this.range.stop(1,1)[l?"animate":"css"]({height:b+"%"},h.animate);if("max"===g&&"vertical"===
this.orientation)this.range.stop(1,1)[l?"animate":"css"]({height:100-b+"%"},h.animate)}},_handleEvents:{keydown:function(a){var b,c,f,e=d(a.target).data("ui-slider-handle-index");switch(a.keyCode){case d.ui.keyCode.HOME:case d.ui.keyCode.END:case d.ui.keyCode.PAGE_UP:case d.ui.keyCode.PAGE_DOWN:case d.ui.keyCode.UP:case d.ui.keyCode.RIGHT:case d.ui.keyCode.DOWN:case d.ui.keyCode.LEFT:if(a.preventDefault(),!this._keySliding&&(this._keySliding=!0,this._addClass(d(a.target),null,"ui-state-active"),b=
this._start(a,e),!1===b))return}f=this.options.step;b=this._hasMultipleValues()?c=this.values(e):c=this.value();switch(a.keyCode){case d.ui.keyCode.HOME:c=this._valueMin();break;case d.ui.keyCode.END:c=this._valueMax();break;case d.ui.keyCode.PAGE_UP:c=this._trimAlignValue(b+(this._valueMax()-this._valueMin())/this.numPages);break;case d.ui.keyCode.PAGE_DOWN:c=this._trimAlignValue(b-(this._valueMax()-this._valueMin())/this.numPages);break;case d.ui.keyCode.UP:case d.ui.keyCode.RIGHT:if(b===this._valueMax())return;
c=this._trimAlignValue(b+f);break;case d.ui.keyCode.DOWN:case d.ui.keyCode.LEFT:if(b===this._valueMin())return;c=this._trimAlignValue(b-f)}this._slide(a,e,c)},keyup:function(a){var b=d(a.target).data("ui-slider-handle-index");this._keySliding&&(this._keySliding=!1,this._stop(a,b),this._change(a,b),this._removeClass(d(a.target),null,"ui-state-active"))}}});d.widget("ui.spinner",{version:"1.13.2",defaultElement:"<input>",widgetEventPrefix:"spin",options:{classes:{"ui-spinner":"ui-corner-all","ui-spinner-down":"ui-corner-br",
...
"ui-spinner-button ui-spinner-up");this._addClass(this.buttons.last(),"ui-spinner-button ui-spinner-down");this.buttons.first().button({icon:this.options.icons.up,showLabel:!1});this.buttons.last().button({icon:this.options.icons.down,showLabel:!1});this.buttons.height()>Math.ceil(0.5*this.uiSpinner.height())&&0<this.uiSpinner.height()&&this.uiSpinner.height(this.uiSpinner.height())},_keydown:function(a){var b=this.options,c=d.ui.keyCode;switch(a.keyCode){case c.UP:return this._repeat(null,1,a),!0;
...
!!a);this.element.prop("disabled",!!a);this.buttons.button(a?"disable":"enable")},_setOptions:I(function(a){this._super(a)}),_parse:function(a){"string"===typeof a&&""!==a&&(a=window.Globalize&&this.options.numberFormat?Globalize.parseFloat(a,10,this.options.culture):+a);return""===a||isNaN(a)?null:a},_format:function(a){return""===a?"":window.Globalize&&this.options.numberFormat?Globalize.format(a,this.options.numberFormat,this.options.culture):a},_refresh:function(){this.element.attr({"aria-valuemin":this.options.min,
"aria-valuemax":this.options.max,"aria-valuenow":this._parse(this.element.val())})},isValid:function(){var a=this.value();return null===a?!1:a===this._adjustValue(a)},_value:function(a,b){var c;""!==a&&(c=this._parse(a),null!==c&&(b||(c=this._adjustValue(c)),a=this._format(c)));this.element.val(a);this._refresh()},_destroy:function(){this.element.prop("disabled",!1).removeAttr("autocomplete role aria-valuemin aria-valuemax aria-valuenow");this.uiSpinner.replaceWith(this.element)},stepUp:I(function(a){this._stepUp(a)}),
_stepUp:function(a){this._start()&&(this._spin((a||1)*this.options.step),this._stop())},stepDown:I(function(a){this._stepDown(a)}),_stepDown:function(a){this._start()&&(this._spin((a||1)*-this.options.step),this._stop())},pageUp:I(function(a){this._stepUp((a||1)*this.options.page)}),pageDown:I(function(a){this._stepDown((a||1)*this.options.page)}),value:function(a){if(!arguments.length)return this._parse(this.element.val());I(this._value).call(this,a)},widget:function(){return this.uiSpinner}});!1!==
...
e){if(d(e).attr("aria-controls")===c)return a=b,!1}),null===a&&(a=this.tabs.index(this.tabs.filter(".ui-tabs-active"))),null===a||-1===a))a=this.tabs.length?0:!1;!1!==a&&(a=this.tabs.index(this.tabs.eq(a)),-1===a&&(a=b?!1:0));!b&&(!1===a&&this.anchors.length)&&(a=0);return a},_getCreateEventData:function(){return{tab:this.active,panel:!this.active.length?d():this._getPanelForTab(this.active)}},_tabKeydown:function(a){var b=d(d.ui.safeActiveElement(this.document[0])).closest("li"),c=this.tabs.index(b),
...
null,b),!b&&!1===this.options.active&&this._activate(0)),"event"===a&&this._setupEvents(b),"heightStyle"===a&&this._setupHeightStyle(b))},_sanitizeSelector:function(a){return a?a.replace(/[!"$%&'()*+,.\/:;<=>?@\[\]\^`{|}~]/g,"\\$&"):""},refresh:function(){var a=this.options,b=this.tablist.children(":has(a[href])");a.disabled=d.map(b.filter(".ui-state-disabled"),function(a){return b.index(a)});this._processTabs();!1===a.active||!this.anchors.length?(a.active=!1,this.active=d()):this.active.length&&
!d.contains(this.tablist[0],this.active[0])?this.tabs.length===a.disabled.length?(a.active=!1,this.active=d()):this._activate(this._findNextTab(Math.max(0,a.active-1),!1)):a.active=this.tabs.index(this.active);this._refresh()},_refresh:function(){this._setOptionDisabled(this.options.disabled);this._setupEvents(this.options.event);this._setupHeightStyle(this.options.heightStyle);this.tabs.not(this.active).attr({"aria-selected":"false","aria-expanded":"false",tabIndex:-1});this.panels.not(this._getPanelForTab(this.active)).hide().attr({"aria-hidden":"true"});
...
c){var f,k,l=d(c).uniqueId().attr("id"),m=d(c).closest("li"),n=m.attr("aria-controls");a._isLocal(c)?(f=c.hash,k=f.substring(1),f=a.element.find(a._sanitizeSelector(f))):(k=m.attr("aria-controls")||d({}).uniqueId()[0].id,f=a.element.find("#"+k),f.length||(f=a._createPanel(k),f.insertAfter(a.panels[b-1]||a.tablist)),f.attr("aria-live","polite"));f.length&&(a.panels=a.panels.add(f));n&&m.data("ui-tabs-aria-controls",n);m.attr({"aria-controls":k,"aria-labelledby":l});f.attr("aria-labelledby",l)});this.panels.attr("role",
"tabpanel");this._addClass(this.panels,"ui-tabs-panel","ui-widget-content");b&&(this._off(b.not(this.tabs)),this._off(c.not(this.anchors)),this._off(f.not(this.panels)))},_getList:function(){return this.tablist||this.element.find("ol, ul").eq(0)},_createPanel:function(a){return d("<div>").attr("id",a).data("ui-tabs-destroy",!0)},_setOptionDisabled:function(a){var b,c;Array.isArray(a)&&(a.length?a.length===this.anchors.length&&(a=!0):a=!1);for(c=0;b=this.tabs[c];c++)b=d(b),!0===a||-1!==d.inArray(c,
a)?(b.attr("aria-disabled","true"),this._addClass(b,null,"ui-state-disabled")):(b.removeAttr("aria-disabled"),this._removeClass(b,null,"ui-state-disabled"));this.options.disabled=a;this._toggleClass(this.widget(),this.widgetFullName+"-disabled",null,!0===a)},_setupEvents:function(a){var b={};a&&d.each(a.split(" "),function(a,d){b[d]="_eventHandler"});this._off(this.anchors.add(this.tabs).add(this.panels));this._on(!0,this.anchors,{click:function(a){a.preventDefault()}});this._on(this.anchors,b);this._on(this.tabs,
...
!this.running&&!(e&&!b.collapsible||!1===this._trigger("beforeActivate",a,c)))b.active=g?!1:this.tabs.index(f),this.active=e?d():f,this.xhr&&this.xhr.abort(),!k.length&&!h.length&&d.error("jQuery UI Tabs: Mismatching fragment identifier."),h.length&&this.load(this.tabs.index(f),a),this._toggle(a,c)},_toggle:function(a,b){function c(){e.running=!1;e._trigger("activate",a,b)}function f(){e._addClass(b.newTab.closest("li"),"ui-tabs-active","ui-state-active");g.length&&e.options.show?e._show(g,e.options.show,
c):(g.show(),c())}var e=this,g=b.newPanel,h=b.oldPanel;this.running=!0;h.length&&this.options.hide?this._hide(h,this.options.hide,function(){e._removeClass(b.oldTab.closest("li"),"ui-tabs-active","ui-state-active");f()}):(this._removeClass(b.oldTab.closest("li"),"ui-tabs-active","ui-state-active"),h.hide(),f());h.attr("aria-hidden","true");b.oldTab.attr({"aria-selected":"false","aria-expanded":"false"});g.length&&h.length?b.oldTab.attr("tabIndex",-1):g.length&&this.tabs.filter(function(){return 0===
...
d.inArray(a,b))return;b=Array.isArray(b)?d.merge([a],b).sort():[a]}this._setOptionDisabled(b)}},load:function(a,b){a=this._getIndex(a);var c=this,f=this.tabs.eq(a),e=f.find(".ui-tabs-anchor"),g=this._getPanelForTab(f),h={tab:f,panel:g},k=function(a,b){"abort"===b&&c.panels.stop(!1,!0);c._removeClass(f,"ui-tabs-loading");g.removeAttr("aria-busy");a===c.xhr&&delete c.xhr};if(!this._isLocal(e[0])&&(this.xhr=d.ajax(this._ajaxSettings(e,b,h)))&&"canceled"!==this.xhr.statusText)this._addClass(f,"ui-tabs-loading"),
g.attr("aria-busy","true"),this.xhr.done(function(a,d,f){setTimeout(function(){g.html(a);c._trigger("load",b,h);k(f,d)},1)}).fail(function(a,b){setTimeout(function(){k(a,b)},1)})},_ajaxSettings:function(a,b,c){var f=this;return{url:a.attr("href").replace(/#.*$/,""),beforeSend:function(a,g){return f._trigger("beforeLoad",b,d.extend({jqXHR:a,ajaxSettings:g},c))}}},_getPanelForTab:function(a){a=d(a).attr("aria-controls");return this.element.find(this._sanitizeSelector("#"+a))}});!1!==d.uiBackCompat&&
...
var d=this,e=b?b.type:null;if("string"===typeof c||c.nodeType||c.jquery)return this._open(b,a,c);(c=c.call(a[0],function(c){d._delay(function(){a.data("ui-tooltip-open")&&(b&&(b.type=e),this._open(b,a,c))})}))&&this._open(b,a,c)},_open:function(a,b,c){function f(a){k.of=a;g.is(":hidden")||g.position(k)}var e,g,h,k=d.extend({},this.options.position);c&&((e=this._find(b))?e.tooltip.find(".ui-tooltip-content").html(c):(b.is("[title]")&&(a&&"mouseover"===a.type?b.attr("title",""):b.removeAttr("title")),
e=this._tooltip(b),g=e.tooltip,this._addDescribedBy(b,g.attr("id")),g.find(".ui-tooltip-content").html(c),this.liveRegion.children().hide(),c=d("<div>").html(g.find(".ui-tooltip-content").html()),c.removeAttr("name").find("[name]").removeAttr("name"),c.removeAttr("id").find("[id]").removeAttr("id"),c.appendTo(this.liveRegion),this.options.track&&a&&/^mouse/.test(a.type)?(this._on(this.document,{mousemove:f}),f(a)):g.position(d.extend({of:b},this.options.position)),g.hide(),this._show(g,this.options.show),
this.options.track&&(this.options.show&&this.options.show.delay)&&(h=this.delayedShow=setInterval(function(){g.is(":visible")&&(f(k.of),clearInterval(h))},13)),this._trigger("open",a,{tooltip:g})))},_registerCloseHandlers:function(a,b){var c={keyup:function(a){a.keyCode===d.ui.keyCode.ESCAPE&&(a=d.Event(a),a.currentTarget=b[0],this.close(a,!0))}};b[0]!==this.element[0]&&(c.remove=function(){var a=this._find(b);a&&this._removeTooltip(a.tooltip)});if(!a||"mouseover"===a.type)c.mouseleave="close";if(!a||
"focusin"===a.type)c.focusout="close";this._on(!0,b,c)},close:function(a){var b,c=this,f=d(a?a.currentTarget:this.element),e=this._find(f);e?(b=e.tooltip,e.closing||(clearInterval(this.delayedShow),f.data("ui-tooltip-title")&&!f.attr("title")&&f.attr("title",f.data("ui-tooltip-title")),this._removeDescribedBy(f),e.hiding=!0,b.stop(!0),this._hide(b,this.options.hide,function(){c._removeTooltip(d(this))}),f.removeData("ui-tooltip-open"),this._off(f,"mouseleave focusout keyup"),f[0]!==this.element[0]&&
this._off(f,"remove"),this._off(this.document,"mousemove"),a&&"mouseleave"===a.type&&d.each(this.parents,function(a,b){d(b.element).attr("title",b.title);delete c.parents[a]}),e.closing=!0,this._trigger("close",a,{tooltip:b}),e.hiding||(e.closing=!1))):f.removeData("ui-tooltip-open")},_tooltip:function(a){var b=d("<div>").attr("role","tooltip"),c=d("<div>").appendTo(b),f=b.uniqueId().attr("id");this._addClass(c,"ui-tooltip-content");this._addClass(b,"ui-tooltip","ui-widget ui-widget-content");b.appendTo(this._appendTo(a));
return this.tooltips[f]={element:a,tooltip:b}},_find:function(a){return(a=a.data("ui-tooltip-id"))?this.tooltips[a]:null},_removeTooltip:function(a){clearInterval(this.delayedShow);a.remove();delete this.tooltips[a.attr("id")]},_appendTo:function(a){a=a.closest(".ui-front, dialog");a.length||(a=this.document[0].body);return a},_destroy:function(){var a=this;d.each(this.tooltips,function(b,c){var f=d.Event("blur"),e=c.element;f.target=f.currentTarget=e[0];a.close(f,!0);d("#"+b).remove();e.data("ui-tooltip-title")&&
(e.attr("title")||e.attr("title",e.data("ui-tooltip-title")),e.removeData("ui-tooltip-title"))});this.liveRegion.remove()}});!1!==d.uiBackCompat&&d.widget("ui.tooltip",d.ui.tooltip,{options:{tooltipClass:null},_tooltip:function(){var a=this._superApply(arguments);this.options.tooltipClass&&a.tooltip.addClass(this.options.tooltipClass);return a}});var x=d,T={},fa=T.toString,ma=/^([\-+])=\s*(\d+\.?\d*)/,ga=[{re:/rgba?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*,\s*(\d{1,3})\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,parse:function(a){return[a[1],
...
a[3],16),a[4]?(parseInt(a[4]+a[4],16)/255).toFixed(2):1]}},{re:/hsla?\(\s*(\d+(?:\.\d+)?)\s*,\s*(\d+(?:\.\d+)?)\%\s*,\s*(\d+(?:\.\d+)?)\%\s*(?:,\s*(\d?(?:\.\d+)?)\s*)?\)/,space:"hsla",parse:function(a){return[a[1],a[2]/100,a[3]/100,a[4]]}}],z=x.Color=function(a,b,c,d){return new x.Color.fn.parse(a,b,c,d)},F={rgba:{props:{red:{idx:0,type:"byte"},green:{idx:1,type:"byte"},blue:{idx:2,type:"byte"}}},hsla:{props:{hue:{idx:0,type:"degrees"},saturation:{idx:1,type:"percent"},lightness:{idx:2,type:"percent"}}}},
Z={"byte":{floor:!0,max:255},percent:{max:1},degrees:{mod:360,floor:!0}},ca=z.support={},da=x("<p>")[0],R,D=x.each;da.style.cssText="background-color:rgba(1,1,1,.5)";ca.rgba=-1<da.style.backgroundColor.indexOf("rgba");D(F,function(a,b){b.cache="_"+a;b.props.alpha={idx:3,type:"percent",def:1}});x.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "),function(a,b){T["[object "+b+"]"]=b.toLowerCase()});z.fn=x.extend(z.prototype,{parse:function(a,b,c,d){if(void 0===a)return this._rgba=
[null,null,null,null],this;if(a.jquery||a.nodeType)a=x(a).css(b),b=void 0;var e=this,g=J(a),h=this._rgba=[];void 0!==b&&(a=[a,b,c,d],g="array");if("string"===g)return this.parse($(a)||R._default);if("array"===g)return D(F.rgba.props,function(b,c){h[c.idx]=Q(a[c.idx],c)}),this;if("object"===g)return a instanceof z?D(F,function(b,c){a[c.cache]&&(e[c.cache]=a[c.cache].slice())}):D(F,function(b,c){var d=c.cache;D(c.props,function(b,f){if(!e[d]&&c.to){if("alpha"===b||null==a[b])return;e[d]=c.to(e._rgba)}e[d][f.idx]=
Q(a[b],f,!0)});e[d]&&0>x.inArray(null,e[d].slice(0,3))&&(null==e[d][3]&&(e[d][3]=1),c.from&&(e._rgba=c.from(e[d])))}),this},is:function(a){var b=z(a),c=!0,d=this;D(F,function(a,g){var h,k=b[g.cache];k&&(h=d[g.cache]||g.to&&g.to(d._rgba)||[],D(g.props,function(a,b){if(null!=k[b.idx])return c=k[b.idx]===h[b.idx]}));return c});return c},_space:function(){var a=[],b=this;D(F,function(c,d){b[d.cache]&&a.push(c)});return a.pop()},transition:function(a,b){var c=z(a),d=c._space(),e=F[d],g=0===this.alpha()?
z("transparent"):this,h=g[e.cache]||e.to(g._rgba),k=h.slice(),c=c[e.cache];D(e.props,function(a,d){var f=d.idx,e=h[f],g=c[f],u=Z[d.type]||{};null!==g&&(null===e?k[f]=g:(u.mod&&(g-e>u.mod/2?e+=u.mod:e-g>u.mod/2&&(e-=u.mod)),k[f]=Q((g-e)*b+e,d)))});return this[d](k)},blend:function(a){if(1===this._rgba[3])return this;var b=this._rgba.slice(),c=b.pop(),d=z(a)._rgba;return z(x.map(b,function(a,b){return(1-c)*d[b]+c*a}))},toRgbaString:function(){var a="rgba(",b=x.map(this._rgba,function(a,b){return null!=
a?a:2<b?1:0});1===b[3]&&(b.pop(),a="rgb(");return a+b.join()+")"},toHslaString:function(){var a="hsla(",b=x.map(this.hsla(),function(a,b){null==a&&(a=2<b?1:0);b&&3>b&&(a=Math.round(100*a)+"%");return a});1===b[3]&&(b.pop(),a="hsl(");return a+b.join()+")"},toHexString:function(a){var b=this._rgba.slice(),c=b.pop();a&&b.push(~~(255*c));return"#"+x.map(b,function(a){a=(a||0).toString(16);return 1===a.length?"0"+a:a}).join("")},toString:function(){return 0===this._rgba[3]?"transparent":this.toRgbaString()}});
z.fn.parse.prototype=z.fn;F.hsla.to=function(a){if(null==a[0]||null==a[1]||null==a[2])return[null,null,null,a[3]];var b=a[0]/255,c=a[1]/255,d=a[2]/255;a=a[3];var e=Math.max(b,c,d),g=Math.min(b,c,d),h=e-g,k=e+g,l=0.5*k;return[Math.round(g===e?0:b===e?60*(c-d)/h+360:c===e?60*(d-b)/h+120:60*(b-c)/h+240)%360,0===h?0:0.5>=l?h/k:h/(2-k),l,null==a?1:a]};F.hsla.from=function(a){if(null==a[0]||null==a[1]||null==a[2])return[null,null,null,a[3]];var b=a[0]/360,c=a[1],d=a[2];a=a[3];c=0.5>=d?d*(1+c):d+c-d*c;d=
2*d-c;return[Math.round(255*U(d,c,b+1/3)),Math.round(255*U(d,c,b)),Math.round(255*U(d,c,b-1/3)),a]};D(F,function(a,b){var c=b.props,d=b.cache,e=b.to,g=b.from;z.fn[a]=function(a){e&&!this[d]&&(this[d]=e(this._rgba));if(void 0===a)return this[d].slice();var b,l=J(a),m="array"===l||"object"===l?a:arguments,n=this[d].slice();D(c,function(a,b){var c=m["object"===l?a:b.idx];null==c&&(c=n[b.idx]);n[b.idx]=Q(c,b)});return g?(b=z(g(n)),b[d]=n,b):z(n)};D(c,function(b,c){z.fn[b]||(z.fn[b]=function(d){var f,
e,g,q;g=J(d);q="alpha"===b?this._hsla?"hsla":"rgba":a;f=this[q]();e=f[c.idx];if("undefined"===g)return e;"function"===g&&(d=d.call(this,e),g=J(d));if(null==d&&c.empty)return this;"string"===g&&(g=ma.exec(d))&&(d=e+parseFloat(g[2])*("+"===g[1]?1:-1));f[c.idx]=d;return this[q](f)})})});z.hook=function(a){a=a.split(" ");D(a,function(a,c){x.cssHooks[c]={set:function(a,b){var d,h="";if("transparent"!==b&&("string"!==J(b)||(d=$(b)))){b=z(d||b);if(!ca.rgba&&1!==b._rgba[3]){for(d="backgroundColor"===c?a.parentNode:
a;(""===h||"transparent"===h)&&d&&d.style;)try{h=x.css(d,"backgroundColor"),d=d.parentNode}catch(k){}b=b.blend(h&&"transparent"!==h?h:"_default")}b=b.toRgbaString()}try{a.style[c]=b}catch(l){}}};x.fx.step[c]=function(a){a.colorInit||(a.start=z(a.elem,c),a.end=z(a.end),a.colorInit=!0);x.cssHooks[c].set(a.elem,a.start.transition(a.end,a.pos))}})};z.hook("backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor");
x.cssHooks.borderColor={expand:function(a){var b={};D(["Top","Right","Bottom","Left"],function(c,d){b["border"+d+"Color"]=a});return b}};R=x.Color.names={aqua:"#00ffff",black:"#000000",blue:"#0000ff",fuchsia:"#ff00ff",gray:"#808080",green:"#008000",lime:"#00ff00",maroon:"#800000",navy:"#000080",olive:"#808000",purple:"#800080",red:"#ff0000",silver:"#c0c0c0",teal:"#008080",white:"#ffffff",yellow:"#ffff00",transparent:[null,null,null,0],_default:"#ffffff"};var V="ui-effects-animated";d.effects={effect:{}};
(function(){function a(a){return a.replace(/-([\da-z])/gi,function(a,b){return b.toUpperCase()})}function b(b){var c,d=b.ownerDocument.defaultView?b.ownerDocument.defaultView.getComputedStyle(b,null):b.currentStyle,f={};if(d&&d.length&&d[0]&&d[d[0]])for(b=d.length;b--;)c=d[b],"string"===typeof d[c]&&(f[a(c)]=d[c]);else for(c in d)"string"===typeof d[c]&&(f[c]=d[c]);return f}var c=["add","remove","toggle"],f={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,
margin:1,padding:1};d.each(["borderLeftStyle","borderRightStyle","borderBottomStyle","borderTopStyle"],function(a,b){d.fx.step[b]=function(a){if("none"!==a.end&&!a.setAttr||1===a.pos&&!a.setAttr)x.style(a.elem,b,a.end),a.setAttr=!0}});d.fn.addBack||(d.fn.addBack=function(a){return this.add(null==a?this.prevObject:this.prevObject.filter(a))});d.effects.animateClass=function(a,g,h,k){var l=d.speed(g,h,k);return this.queue(function(){var g=d(this),h=g.attr("class")||"",k,q=l.children?g.find("*").addBack():
g,q=q.map(function(){return{el:d(this),start:b(this)}});k=function(){d.each(c,function(b,c){if(a[c])g[c+"Class"](a[c])})};k();q=q.map(function(){this.end=b(this.el[0]);var a=this.start,c=this.end,e={},g,h;for(g in c)if(h=c[g],a[g]!==h&&!f[g]&&(d.fx.step[g]||!isNaN(parseFloat(h))))e[g]=h;this.diff=e;return this});g.attr("class",h);q=q.map(function(){var a=this,b=d.Deferred(),c=d.extend({},l,{queue:!1,complete:function(){b.resolve(a)}});this.el.animate(this.diff,c);return b.promise()});d.when.apply(d,
q.get()).done(function(){k();d.each(arguments,function(){var a=this.el;d.each(this.diff,function(b){a.css(b,"")})});l.complete.call(g[0])})})};d.fn.extend({addClass:function(a){return function(b,c,f,l){return c?d.effects.animateClass.call(this,{add:b},c,f,l):a.apply(this,arguments)}}(d.fn.addClass),removeClass:function(a){return function(b,c,f,l){return 1<arguments.length?d.effects.animateClass.call(this,{remove:b},c,f,l):a.apply(this,arguments)}}(d.fn.removeClass),toggleClass:function(a){return function(b,
c,f,l,m){return"boolean"===typeof c||void 0===c?f?d.effects.animateClass.call(this,c?{add:b}:{remove:b},f,l,m):a.apply(this,arguments):d.effects.animateClass.call(this,{toggle:b},c,f,l)}}(d.fn.toggleClass),switchClass:function(a,b,c,f,l){return d.effects.animateClass.call(this,{add:b,remove:a},c,f,l)}})})();(function(){function a(a,b,c,h){d.isPlainObject(a)&&(b=a,a=a.effect);a={effect:a};null==b&&(b={});"function"===typeof b&&(h=b,c=null,b={});if("number"===typeof b||d.fx.speeds[b])h=c,c=b,b={};"function"===
typeof c&&(h=c,c=null);b&&d.extend(a,b);c=c||b.duration;a.duration=d.fx.off?0:"number"===typeof c?c:c in d.fx.speeds?d.fx.speeds[c]:d.fx.speeds._default;a.complete=h||b.complete;return a}function b(a){return!a||("number"===typeof a||d.fx.speeds[a])||"string"===typeof a&&!d.effects.effect[a]||"function"===typeof a||"object"===typeof a&&!a.effect?!0:!1}function c(a,b){var c=b.outerWidth(),d=b.outerHeight(),k=/^rect\((-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto)\)$/.exec(a)||
["",0,c,d,0];return{top:parseFloat(k[1])||0,right:"auto"===k[2]?c:parseFloat(k[2]),bottom:"auto"===k[3]?d:parseFloat(k[3]),left:parseFloat(k[4])||0}}d.expr&&(d.expr.pseudos&&d.expr.pseudos.animated)&&(d.expr.pseudos.animated=function(a){return function(b){return!!d(b).data(V)||a(b)}}(d.expr.pseudos.animated));!1!==d.uiBackCompat&&d.extend(d.effects,{save:function(a,b){for(var c=0,d=b.length;c<d;c++)null!==b[c]&&a.data("ui-effects-"+b[c],a[0].style[b[c]])},restore:function(a,b){for(var c,d=0,k=b.length;d<
k;d++)null!==b[d]&&(c=a.data("ui-effects-"+b[d]),a.css(b[d],c))},setMode:function(a,b){"toggle"===b&&(b=a.is(":hidden")?"show":"hide");return b},createWrapper:function(a){if(a.parent().is(".ui-effects-wrapper"))return a.parent();var b={width:a.outerWidth(!0),height:a.outerHeight(!0),"float":a.css("float")},c=d("<div></div>").addClass("ui-effects-wrapper").css({fontSize:"100%",background:"transparent",border:"none",margin:0,padding:0}),h={width:a.width(),height:a.height()},k=document.activeElement;
...
"toggle"===b&&(b=c?"show":"hide");if(c?"hide"===b:"show"===b)b="none";return b},getBaseline:function(a,b){var c,d;switch(a[0]){case "top":c=0;break;case "middle":c=0.5;break;case "bottom":c=1;break;default:c=a[0]/b.height}switch(a[1]){case "left":d=0;break;case "center":d=0.5;break;case "right":d=1;break;default:d=a[1]/b.width}return{x:d,y:c}},createPlaceholder:function(a){var b,c=a.css("position"),h=a.position();a.css({marginTop:a.css("marginTop"),marginBottom:a.css("marginBottom"),marginLeft:a.css("marginLeft"),
...
a.data("ui-effects-placeholder",b));a.css({position:c,left:h.left,top:h.top});return b},removePlaceholder:function(a){var b=a.data("ui-effects-placeholder");b&&(b.remove(),a.removeData("ui-effects-placeholder"))},cleanUp:function(a){d.effects.restoreStyle(a);d.effects.removePlaceholder(a)},setTransition:function(a,b,c,h){h=h||{};d.each(b,function(b,d){var e=a.cssUnit(d);0<e[0]&&(h[d]=e[0]*c+e[1])});return h}});d.fn.extend({effect:function(){function b(a){function f(){l.removeData(V);d.effects.cleanUp(l);
"hide"===c.mode&&l.hide();k()}function k(){"function"===typeof m&&m.call(l[0]);"function"===typeof a&&a()}var l=d(this);c.mode=p.shift();!1!==d.uiBackCompat&&!h?(l.is(":hidden")?"hide"===n:"show"===n)?(l[n](),k()):g.call(l[0],c,k):"none"===c.mode?(l[n](),k()):g.call(l[0],c,f)}var c=a.apply(this,arguments),g=d.effects.effect[c.effect],h=g.mode,k=c.queue,l=k||"fx",m=c.complete,n=c.mode,p=[],q=function(a){var b=d(this),c=d.effects.mode(b,n)||h;b.data(V,!0);p.push(c);h&&("show"===c||c===h&&"hide"===c)&&
b.show();(!h||"none"!==c)&&d.effects.saveStyle(b);"function"===typeof a&&a()};return d.fx.off||!g?n?this[n](c.duration,m):this.each(function(){m&&m.call(this)}):!1===k?this.each(q).each(b):this.queue(l,q).queue(l,b)},show:function(c){return function(d){if(b(d))return c.apply(this,arguments);var g=a.apply(this,arguments);g.mode="show";return this.effect.call(this,g)}}(d.fn.show),hide:function(c){return function(d){if(b(d))return c.apply(this,arguments);var g=a.apply(this,arguments);g.mode="hide";return this.effect.call(this,
g)}}(d.fn.hide),toggle:function(c){return function(d){if(b(d)||"boolean"===typeof d)return c.apply(this,arguments);var g=a.apply(this,arguments);g.mode="toggle";return this.effect.call(this,g)}}(d.fn.toggle),cssUnit:function(a){var b=this.css(a),c=[];d.each(["em","px","%","pt"],function(a,d){0<b.indexOf(d)&&(c=[parseFloat(b),d])});return c},cssClip:function(a){return a?this.css("clip","rect("+a.top+"px "+a.right+"px "+a.bottom+"px "+a.left+"px)"):c(this.css("clip"),this)},transfer:function(a,b){var c=
d(this),h=d(a.to),k="fixed"===h.css("position"),l=d("body"),m=k?l.scrollTop():0,l=k?l.scrollLeft():0,n=h.offset(),h={top:n.top-m,left:n.left-l,height:h.innerHeight(),width:h.innerWidth()},n=c.offset(),p=d("<div class='ui-effects-transfer'></div>");p.appendTo("body").addClass(a.className).css({top:n.top-m,left:n.left-l,height:c.innerHeight(),width:c.innerWidth(),position:k?"fixed":"absolute"}).animate(h,a.duration,a.easing,function(){p.remove();"function"===typeof b&&b()})}});d.fx.step.clip=function(a){a.clipInit||
(a.start=d(a.elem).cssClip(),"string"===typeof a.end&&(a.end=c(a.end,a.elem)),a.clipInit=!0);d(a.elem).cssClip({top:a.pos*(a.end.top-a.start.top)+a.start.top,right:a.pos*(a.end.right-a.start.right)+a.start.right,bottom:a.pos*(a.end.bottom-a.start.bottom)+a.start.bottom,left:a.pos*(a.end.left-a.start.left)+a.start.left})}})();(function(){var a={};d.each(["Quad","Cubic","Quart","Quint","Expo"],function(b,c){a[c]=function(a){return Math.pow(a,b+2)}});d.extend(a,{Sine:function(a){return 1-Math.cos(a*
Math.PI/2)},Circ:function(a){return 1-Math.sqrt(1-a*a)},Elastic:function(a){return 0===a||1===a?a:-Math.pow(2,8*(a-1))*Math.sin((80*(a-1)-7.5)*Math.PI/15)},Back:function(a){return a*a*(3*a-2)},Bounce:function(a){for(var c,d=4;a<((c=Math.pow(2,--d))-1)/11;);return 1/Math.pow(4,3-d)-7.5625*Math.pow((3*c-2)/22-a,2)}});d.each(a,function(a,c){d.easing["easeIn"+a]=c;d.easing["easeOut"+a]=function(a){return 1-c(1-a)};d.easing["easeInOut"+a]=function(a){return 0.5>a?c(2*a)/2:1-c(-2*a+2)/2}})})();d.effects.define("blind",
"hide",function(a,b){var c={up:["bottom","top"],vertical:["bottom","top"],down:["top","bottom"],left:["right","left"],horizontal:["right","left"],right:["left","right"]},f=d(this),e=a.direction||"up",g=f.cssClip(),h={clip:d.extend({},g)},k=d.effects.createPlaceholder(f);h.clip[c[e][0]]=h.clip[c[e][1]];"show"===a.mode&&(f.cssClip(h.clip),k&&k.css(d.effects.clipToBox(h)),h.clip=g);k&&k.animate(d.effects.clipToBox(h),a.duration,a.easing);f.animate(h,{queue:!1,duration:a.duration,easing:a.easing,complete:b})});
d.effects.define("bounce",function(a,b){var c,f,e=d(this),g=a.mode,h="hide"===g;f="show"===g;var k=a.direction||"up",g=a.distance,l=a.times||5,m=2*l+(f||h?1:0),n=a.duration/m,p=a.easing,q="up"===k||"down"===k?"top":"left",k="up"===k||"left"===k,u=0,t=e.queue().length;d.effects.createPlaceholder(e);c=e.css(q);g||(g=e["top"===q?"outerHeight":"outerWidth"]()/3);f&&(f={opacity:1},f[q]=c,e.css("opacity",0).css(q,k?2*-g:2*g).animate(f,n,p));h&&(g/=Math.pow(2,l-1));f={};for(f[q]=c;u<l;u++)c={},c[q]=(k?"-=":
"+=")+g,e.animate(c,n,p).animate(f,n,p),g=h?2*g:g/2;h&&(c={opacity:0},c[q]=(k?"-=":"+=")+g,e.animate(c,n,p));e.queue(b);d.effects.unshift(e,t,m+1)});d.effects.define("clip","hide",function(a,b){var c,f={},e=d(this);c=a.direction||"vertical";var g="both"===c,h=g||"horizontal"===c,g=g||"vertical"===c;c=e.cssClip();f.clip={top:g?(c.bottom-c.top)/2:c.top,right:h?(c.right-c.left)/2:c.right,bottom:g?(c.bottom-c.top)/2:c.bottom,left:h?(c.right-c.left)/2:c.left};d.effects.createPlaceholder(e);"show"===a.mode&&
(e.cssClip(f.clip),f.clip=c);e.animate(f,{queue:!1,duration:a.duration,easing:a.easing,complete:b})});d.effects.define("drop","hide",function(a,b){var c,f=d(this),e="show"===a.mode;c=a.direction||"left";var g="up"===c||"down"===c?"top":"left",h="up"===c||"left"===c?"-=":"+=",k="+="===h?"-=":"+=",l={opacity:0};d.effects.createPlaceholder(f);c=a.distance||f["top"===g?"outerHeight":"outerWidth"](!0)/2;l[g]=h+c;e&&(f.css(l),l[g]=k+c,l.opacity=1);f.animate(l,{queue:!1,duration:a.duration,easing:a.easing,
complete:b})});d.effects.define("explode","hide",function(a,b){function c(){s.push(this);s.length===m*n&&(p.css({visibility:"visible"}),d(s).remove(),b())}var f,e,g,h,k,l,m=a.pieces?Math.round(Math.sqrt(a.pieces)):3,n=m,p=d(this),q="show"===a.mode,u=p.show().css("visibility","hidden").offset(),t=Math.ceil(p.outerWidth()/n),r=Math.ceil(p.outerHeight()/m),s=[];for(f=0;f<m;f++){h=u.top+f*r;l=f-(m-1)/2;for(e=0;e<n;e++)g=u.left+e*t,k=e-(n-1)/2,p.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",
visibility:"visible",left:-e*t,top:-f*r}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:t,height:r,left:g+(q?k*t:0),top:h+(q?l*r:0),opacity:q?0:1}).animate({left:g+(q?0:k*t),top:h+(q?0:l*r),opacity:q?1:0},a.duration||500,a.easing,c)}});d.effects.define("fade","toggle",function(a,b){var c="show"===a.mode;d(this).css("opacity",c?0:1).animate({opacity:c?1:0},{queue:!1,duration:a.duration,easing:a.easing,complete:b})});d.effects.define("fold","hide",function(a,
b){var c=d(this),f=a.mode,e="show"===f,f="hide"===f,g=a.size||15,h=/([0-9]+)%/.exec(g),k=a.horizFirst?["right","bottom"]:["bottom","right"],l=a.duration/2,m=d.effects.createPlaceholder(c),n=c.cssClip(),p={clip:d.extend({},n)},q={clip:d.extend({},n)},u=[n[k[0]],n[k[1]]],t=c.queue().length;h&&(g=parseInt(h[1],10)/100*u[f?0:1]);p.clip[k[0]]=g;q.clip[k[0]]=g;q.clip[k[1]]=0;e&&(c.cssClip(q.clip),m&&m.css(d.effects.clipToBox(q)),q.clip=n);c.queue(function(b){m&&m.animate(d.effects.clipToBox(p),l,a.easing).animate(d.effects.clipToBox(q),
l,a.easing);b()}).animate(p,l,a.easing).animate(q,l,a.easing).queue(b);d.effects.unshift(c,t,4)});d.effects.define("highlight","show",function(a,b){var c=d(this),f={backgroundColor:c.css("backgroundColor")};"hide"===a.mode&&(f.opacity=0);d.effects.saveStyle(c);c.css({backgroundImage:"none",backgroundColor:a.color||"#ffff99"}).animate(f,{queue:!1,duration:a.duration,easing:a.easing,complete:b})});d.effects.define("size",function(a,b){var c,f,e,g,h,k,l=d(this),m=["fontSize"],n=["borderTopWidth","borderBottomWidth",
"paddingTop","paddingBottom"],p=["borderLeftWidth","borderRightWidth","paddingLeft","paddingRight"];k=a.mode;var q="effect"!==k,u=a.scale||"both";h=a.origin||["middle","center"];var t=l.css("position"),r=l.position(),s=d.effects.scaledDimensions(l),v=a.from||s,w=a.to||d.effects.scaledDimensions(l,0);d.effects.createPlaceholder(l);"show"===k&&(k=v,v=w,w=k);e=v.height/s.height;g=v.width/s.width;c=w.height/s.height;f=w.width/s.width;if("box"===u||"both"===u)e!==c&&(v=d.effects.setTransition(l,n,e,v),
w=d.effects.setTransition(l,n,c,w)),g!==f&&(v=d.effects.setTransition(l,p,g,v),w=d.effects.setTransition(l,p,f,w));if(("content"===u||"both"===u)&&e!==c)v=d.effects.setTransition(l,m,e,v),w=d.effects.setTransition(l,m,c,w);h&&(h=d.effects.getBaseline(h,s),v.top=(s.outerHeight-v.outerHeight)*h.y+r.top,v.left=(s.outerWidth-v.outerWidth)*h.x+r.left,w.top=(s.outerHeight-w.outerHeight)*h.y+r.top,w.left=(s.outerWidth-w.outerWidth)*h.x+r.left);delete v.outerHeight;delete v.outerWidth;l.css(v);if("content"===
u||"both"===u)n=n.concat(["marginTop","marginBottom"]).concat(m),p=p.concat(["marginLeft","marginRight"]),l.find("*[width]").each(function(){var b=d(this),h=d.effects.scaledDimensions(b),k={height:h.height*e,width:h.width*g,outerHeight:h.outerHeight*e,outerWidth:h.outerWidth*g},h={height:h.height*c,width:h.width*f,outerHeight:h.height*c,outerWidth:h.width*f};e!==c&&(k=d.effects.setTransition(b,n,e,k),h=d.effects.setTransition(b,n,c,h));g!==f&&(k=d.effects.setTransition(b,p,g,k),h=d.effects.setTransition(b,
p,f,h));q&&d.effects.saveStyle(b);b.css(k);b.animate(h,a.duration,a.easing,function(){q&&d.effects.restoreStyle(b)})});l.animate(w,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){var a=l.offset();0===w.opacity&&l.css("opacity",v.opacity);q||(l.css("position","static"===t?"relative":t).offset(a),d.effects.saveStyle(l));b()}})});d.effects.define("scale",function(a,b){var c=d(this),f=a.mode,f=parseInt(a.percent,10)||(0===parseInt(a.percent,10)?0:"effect"!==f?0:100),c=d.extend(!0,{from:d.effects.scaledDimensions(c),
to:d.effects.scaledDimensions(c,f,a.direction||"both"),origin:a.origin||["middle","center"]},a);a.fade&&(c.from.opacity=1,c.to.opacity=0);d.effects.effect.size.call(this,c,b)});d.effects.define("puff","hide",function(a,b){var c=d.extend(!0,{},a,{fade:!0,percent:parseInt(a.percent,10)||150});d.effects.effect.scale.call(this,c,b)});d.effects.define("pulsate","show",function(a,b){var c=d(this),f=a.mode,e="show"===f,f=2*(a.times||5)+(e||"hide"===f?1:0),g=a.duration/f,h=0,k=1,l=c.queue().length;if(e||
!c.is(":visible"))c.css("opacity",0).show(),h=1;for(;k<f;k++)c.animate({opacity:h},g,a.easing),h=1-h;c.animate({opacity:h},g,a.easing);c.queue(b);d.effects.unshift(c,l,f+1)});d.effects.define("shake",function(a,b){var c=1,f=d(this),e=a.direction||"left",g=a.distance||20,h=a.times||3,k=2*h+1,l=Math.round(a.duration/k),m="up"===e||"down"===e?"top":"left",e="up"===e||"left"===e,n={},p={},q={},u=f.queue().length;d.effects.createPlaceholder(f);n[m]=(e?"-=":"+=")+g;p[m]=(e?"+=":"-=")+2*g;q[m]=(e?"-=":"+=")+
2*g;for(f.animate(n,l,a.easing);c<h;c++)f.animate(p,l,a.easing).animate(q,l,a.easing);f.animate(p,l,a.easing).animate(n,l/2,a.easing).queue(b);d.effects.unshift(f,u,k+1)});d.effects.define("slide","show",function(a,b){var c,f,e=d(this),g={up:["bottom","top"],down:["top","bottom"],left:["right","left"],right:["left","right"]},h=a.mode,k=a.direction||"left",l="up"===k||"down"===k?"top":"left",m="up"===k||"left"===k,n=a.distance||e["top"===l?"outerHeight":"outerWidth"](!0),p={};d.effects.createPlaceholder(e);
c=e.cssClip();f=e.position()[l];p[l]=(m?-1:1)*n+f;p.clip=e.cssClip();p.clip[g[k][1]]=p.clip[g[k][0]];"show"===h&&(e.cssClip(p.clip),e.css(l,p[l]),p.clip=c,p[l]=f);e.animate(p,{queue:!1,duration:a.duration,easing:a.easing,complete:b})});!1!==d.uiBackCompat&&d.effects.define("transfer",function(a,b){d(this).transfer(a,b)})});
